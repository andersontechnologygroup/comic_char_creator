...
const POWER_LIST_ADVANCED_TABLE = [
    ...
    },
    {
        ...
        name: "Psionic Attack",
        description:
            "This Power gives the hero the ability to project psionic force blasts at Power rank range and Intensity. The target of this attack must make a successful Psyche FEAT or be knocked unconscious for 1-10 rounds. Characters with Mental Powers may use their Power ranks instead of Psyche, and those with Psi-Screen should use that Power rank before any other. Force Field's operate against psionic attack. ",
        bonusPowerCount: 4,
        bonusPower:
