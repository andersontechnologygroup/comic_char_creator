...
const PHYSICAL_FORM_ADVANCED_TABLE = [
    ...
    },
    {
        ...
        talentCategory: "Scientific Skills",
    },
    {
        maxRoll: 95,
        name: "Robot",
...
const QUANTITY_ADVANCED_TABLE = [
    ...
    {
        maxRoll: 60,
        powers: { initial: 3, maximum: 4 },
        talents: { initial: 2, maximum: 5 },
        contacts: { initial: 1, maximum: 4 },
    },
    {
        maxRoll: 90,
        powers: { initial: 4, maximum: 4 },
        talents: { initial: 3, maximum: 4 },
        contacts: { initial: 2, maximum: 4 },
    },
    {
        maxRoll: 100,
        powers: { initial: 5, maximum: 5 },
...
const POWER_LIST_ADVANCED_TABLE = [
    {
        ...
        description:
            "All damage from fire and heat-based attacks is reduced by the Power rank number. Further, any fire of less than this Power rank has no effect on the hero.",
        upgradePower: "Resistances\\Invulnerability\\Fire and Heat",
    },
    {
        category: "Resistances",
        maxRoll: 20,
        ...
        description:
            "All damage from cold-based attacks is reduced by the Power rank number. Further, ice and cold of less than this Power rank may be ignored. Physical items made of ice may still affect the hero.",
        upgradePower: "Resistances\\Invulnerability\\Cold",
    },
    {
        category: "Resistances",
        maxRoll: 30,
        ...
        description:
            "All damage resulting from electrical-based attacks is reduced by the Power rank number. Further, electricity of less than this Power rank is ignored by the hero. The hero must decide if this Power is conductive or non-conductive in nature. Conductive resistance allows energy to pass through the hero into those the hero is touching (like a copper wire). Non-conductive resistance stops the energy at the contact point, allowing those being touched or held to be unharmed (like rubber insulation). ",
        upgradePower: "Resistances\\Invulnerability\\Electricity",
    },
    {
        category: "Resistances",
        maxRoll: 40,
        name: "Resistance to Radiation",
        description:
            "All damage resulting from radiation-based attacks, including but not limited to X-rays, alpha and beta particles, and gamma rays, is reduced by the Power rank number. Most non-concussive energy rays used by super-powered individuals may be so reduced. Any radiation of a lower Intensity than the hero's Power rank has no effect on the hero. ",
        upgradePower: "Resistances\\Invulnerability\\Radiation",
    },
    {
        category: "Resistances",
        maxRoll: 50,
    ...
    },
    {
        ...
        upgradePower: "Resistances\\Invulnerability\\Corrosives",
    },
    {
        category: "Resistances",
        maxRoll: 70,
        name: "Resistance to Emotion Attacks",
        description:
            "This Power rank will be no less than one rank higher than the character's initial Intuition, and should be raised to that rank +1CS if a lower rank is rolled. Any Emotion-related attacks that affect the Intuition, including illusions, emotion-control, and dominance must overcome this rank as opposed to the Intuition of the individual. ",
        upgradePower: "Resistances\\Invulnerability\\Emotion Attack",
    },
    {
        category: "Resistances",
        maxRoll: 80,
        name: "Resistance to Mental Attacks",
        description:
        ...
        upgradePower: "Resistances\\Invulnerability\\Mental Attack",
    },
    {
        category: "Resistances",
        maxRoll: 90,
        name: "Resistance to Magic Attacks",
        description:
        ...
        upgradePower: "Resistances\\Invulnerability\\Magic Attack",
    },
    {
        category: "Resistances",
        maxRoll: 100,
    ...
    },
    {
        ...
        duplicateCost: 1,
        description:
            "The hero with this Power is totally unaffected by one or more of the attack forms listed above. The initial choosing of Invulnerability counts as two choices, but every additional choice in Resistances may be changed to an Invulnerability. Invulnerability means that the hero in question has a Class 1000 resistance to that attack form.",
    },

    {
        category: "Senses",
        maxRoll: 10,
        name: "Protected Senses",
        description:
            "One or more of the hero's basic senses are protected from attack. The hero ignores potentially damaging attacks of less than the Power rank in Intensity level. In many cases, this considers the effects of specially polarized goggles that prevent being suddenly blinded by high Intensity light, or earplugs or headgear that reduce the effects of sonic attacks. ",
    },
    {
        category: "Senses",
        maxRoll: 20,
    ...
    },
    {
        ...
        name: "Computer Links",
        description:
            "The character with this Power may communicate with and retrieve information from computer systems with Power rank ability. The hero must be able to access the computer in some way; usually this is by means of an implant relayed to a predetermined computer. If attempting to break into a new computer, compare this Power rank with the Reason of the computer or mechanical being. This Power also allows the reprogramming of simple robots. ",
    },
    {
        category: "Senses",
        maxRoll: 50,
        ...
        description:
            "The hero can detect emotion in others with Power rank ability. This Power may be a limited form of Empathy, or merely the ability to catch the subtle physiological clues that indicate a person is under stress, lying, or worried. Success with this FEAT roll indicates the hero detects only the target's emotional state, not the cause of it.  Targets trying to conceal their emotional state use their Intuition as an Intensity rank to determine the type of FEAT required. Detecting non-human emotions - those of robots and aliens, for instance - should be done at a higher shift. ",
    },
    {
        category: "Senses",
        maxRoll: 60,
        ...
        description:
            "The hero with this Power is able to identify specific types of energy and track energy trails. The hero can identify the general type of energy with Power rank ability, and can track the energy trail of that specific type with Power rank ability per hour. Faint trails or common types of energy with confusing patterns may require yellow or red FEATs at the Judge's option. ",
        bonusPowerCount: 1,
        bonusPower: "Senses\\Magic Detection(100)",
    },
    {
        category: "Senses",
        maxRoll: 70,
        name: "Magnetic Detection",
        description:
            "The hero with this Power can detect the magnetic field of Earth (and likely other planets as well), as well as aberrations of that field with Power rank ability. It is difficult for a hero with this Power to become lost.",
        bonusPowerCount: 1,
        bonusPower: "Senses\\Mutant Detection(100)",
    },
    {
        category: "Senses",
        maxRoll: 80,
    ...
    },
    {
        ...
        description:
            "The hero with this Power is attuned to the specific mental radiation given out by mutants. The range is dependent on the Power rank of the individual. (See the Power Rank Range Table). This Power reflects the conscious will to detect mutants. ",
    },
    {
        category: "Senses",
        maxRoll: 120,
    ...
    },
    {
        ...
        powerCount: 2,
        description:
            "This Power rank may be used instead of Intuition for determining surprise, instead of Fighting for blocking, instead of Agility for dodging, and instead of Strength for escaping. The minimum level of this Power is the Intuition rank of the character. ",
    },
    {
        category: "Senses",
        maxRoll: 140,
        ...
        powerCount: 2,
        description:
            "The hero possessing this Power is in tune with the universe to some degree, allowing him to perceive other powerful entities and to detect weaknesses in opponents. Individuals with Class 1000 primary abilities or better within 10 miles of the hero will always be noticed by the hero. In addition, making a Power rank FEAT with this Power allows the user to gain a + 1CS on FEATs against an opponent by finding the weak point in an opponent or structure. ",
    },
    ...
    },
    {
        ...
        name: "Leaping",
        description:
            "The hero with this Power can leap great distances. Use the table on page 24, Chapter 2, replacing Strength with this Power rank. This Power rank will always be at least the Strength of the character + 1CS. If a lower rank is rolled, raise it to this minimum. ",
    },
    {
        category: "Movement",
        maxRoll: 60,
        name: "Wall-Crawling",
        description:
            "The hero can move along vertical and upside-down surfaces as if they were normal surfaces. This Power rank indicates how strong the adhesion is. The hero will use the Power rank to determine the ability to stick, according to the Intensity of the slipperiness of the surface. ",
    },
    {
        category: "Movement",
        maxRoll: 70,
        ...
        description:
            "The hero with this Power can move as a vehicle with a speed equal to the Power rank, as opposed to his distance per round being limited by Endurance. This Power will always be at the Endurance rank + 1CS. If a lower rank is rolled, raise it to this minimum. Lightning Speed is assumed to apply to ground movement, but may be applied to any of the following Powers, if the hero has them in his possession: Flight, Gliding, Wall-crawling, or Digging. Charactors with Lightning Speed can turn at maximum speed without penalty, and Agility FEATs may be made either with the Agility ability or with this Power rank. Charactors with Lightning Speed can accelerate to full speed in a single round, and decelerate from full speed to full stop in the space of one area.",
        bonusPowerCount: 1,
        bonusPower: "Movement\\Teleportation(100)",
    },
    {
        category: "Movement",
        maxRoll: 80,
    ...
    },
    {
        ...
        name: "Climbing",
        description:
            "The hero with this Power can scale vertical (but not upside-down) surfaces as if possessing the Wall-Crawling Power with Lightning Speed. The speed of the climbing is determined by the Power rank, and the surface must have sufficient handholds or cracks. In addition, the hero can move through tangled pipes, vines, and other areas that require manual dexterity using this Power instead of the hero's Agility. ",
        bonusPowerCount: 2,
        bonusPower: "Movement\\Digging(50)|Movement\\Dimensional Travel(100)",
    },
    {
        category: "Movement",
        maxRoll: 110,
    ...
    },
    {
        ...
        name: "Fire Control",
        description:
            "The hero with this Power can control existing fire sources. He can intensify the fire up to the levels of his Power rank, or may reduce the Intensity of the fire by the same amount, reducing fire damage by the rank number. The hero with this Power can manipulate flame, so as to form a fiery shield that will inflict the Power rank number of damage on those who cross it, but cannot initially use the Fire Control to affect targets at a distance.",
    },
    {
        category: "Matter Control",
        maxRoll: 80,
    ...
    },
    {
        ...
        description:
            "The hero with this Power has the ability to manipulate the forces of weather. Using this Power, the hero can duplicate several Power stunts of other control abilities, and in addition create new stunts as well. Weather Control Power stunts cost only 50 Karma points, not the normal 100 points.",
        bonusPowerCount: 3,
        bonusPower:
            "Matter Control\\Density Manipulation - Others(33)|Matter Control\\Body Transformation - Others(66)|Matter Control\\Animal Transformation - Others(100)",
    },
    {
        category: "Matter Control",
        maxRoll: 110,
        name: "Density Manipulation - Others",
        description:
...

    {
        ...
        description:
            "The hero can manipulate magnetic lines of force. Initially, this gives the hero the ability to move and control metallic objects of up to Power rank size at Power rank range with Power rank ability. ",
    },
    {
        category: "Energy Control",
        maxRoll: 40,
        ...
        description:
            "The hero can manipulate and control electricity. Initially, this gives the hero a resistance to electrical attacks equal to this Power rank (raise one of the two Powers if Electrical Resistance is also chosen). ",
    },
    {
        category: "Energy Control",
        maxRoll: 60,
        ...
        description:
            "The hero can generate light and manipulate existing light energy. Such light is of Power rank Intensity and may either be cast in a burst, affecting all targets in the same area, or in a line, affecting a single target. Light used in this fashion inflicts no damage, but may blind the targets with Power rank Intensity. ",
    },
    {
        category: "Energy Control",
        maxRoll: 80,
        ...
        description:
            "The hero can manipulate existing sonic energies, dampening existing noise by the Power rank number in Intensity, or increasing that noise by one level of Intensity if a successful Power rank FEAT is made. The individual with this Power may reduce all sonic-based attacks on his form by the Power rank number. A character with this Power may gain Sound Generation as a bonus Power, which would occupy the next Power slot instead of a randomly rolled Power. ",
    },
    {
        category: "Energy Control",
        maxRoll: 90,
        ...
        description:
            "The hero with this Power can manipulate the extra-dimensional energy known as the Darkforce to perform specific actions. The hero may have one Power Stunt when the character is created. ",
    },
    {
        category: "Energy Control",
        maxRoll: 100,
        ...
        bonusPowerCount: 4,
        bonusPower:
            "Energy Control\\Probability Manipulation(25)|Energy Control\\Nullifying Power(50)|Energy Control\\Energy Reflection(75)|Energy Control\\Time Control(100)",
    },
    {
        category: "Energy Control",
        maxRoll: 110,
    ...
    },
    {
        ...
        powerCount: 2,
        description:
            "Time control is a powerful Power. Should the hero choose it, it will count as two Powers, and the hero will recieve an automatic limitation from the Judge. ",
    },

    {
        ...
        name: "Growth",
        description:
            "The hero with this Power can grow taller at will. The limit of growth is determined by the Power rank, as noted on the table below. The hero may use his Power rank instead of Strength when performing Feats of Strength, including wrestling combat. Charging, slugfest, and missile attacks on an enlarged character all receive positive column shifts to hit. Charactors that experience growth usually but not always draw their additional mass from an unknown source. Charactors with growth are not slowed or impaired by their added mass. Finally, the hero with this Power may choose (as a limitation) to have the Power always in effect. This means the Power is raised one rank initially, but the hero is fixed at that size, permanently. ",
    },
    {
        category: "Body Control",
        maxRoll: 20,
        name: "Shrinking",
        description:
            "The hero with this Power can make himself smaller, while retaining the original strength and abilities. The hero's Strength is unaffected by the shrinking. In addition, the hero may have a column shift modifier that reflects the increase in attacks against larger (normal-sized) foes and the reduction suffered by such foes atacking the hero.",
        bonusPowerCount: 2,
        bonusPower:
            "Body Control\\Density Manipulation - Self(50)|Body Control\\Phasing(100)",
    },
    {
        category: "Body Control",
        maxRoll: 30,
    ...
    },
    {
        ...
        name: "Plasticity",
        description:
            "The body of the hero with this Power is slightly elastic and malleable, and the hero manipulates his body as he sees fit. The hero with this Power may also choose Elongation as a bonus Power, placing that Power in the next slot without a random roll. The plasticity of the body serves as Power rank Body Armor. ",
        bonusPowerCount: 1,
    ...
    },
    {
        ...
        name: "Blending",
        description:
            "The hero has the ability to change his shade to blend in with his surroundings, and has in effect a specialized form of Invisibility. The hero and his uniform, if made of unstable molecules) are hidden with Power rank ability, and will not be detected until the character moves or acts. Should a hero choose a limitation, the Power is raised +2CS, as opposed to the standard + 1CS. ",
        bonusPowerCount: 1,
        bonusPower: "Body Control\\Power Absorption(100)",
    },
    {
        category: "Body Control",
        maxRoll: 100,
    ...
    },
    {
        ...
        description:
            "The hero with this Power can fire bolts of force that inflict Energy-type damage, Force-type damage, or either (determined before attack). One type is gained initially, and the other may be developed as a Power Stunt at full effect. The bolts hit for Power rank range and damage, and use Agility to determine if they hit the target. The hero with Energy Generation may choose to inflict less damage than determined, whether in amount of Health lost, or effects of the attack. (The character may pull his punch.) ",
    },
    {
        category: "Distance Attacks",
        maxRoll: 60,
        ...
        description:
            "The hero with this Power can make sonic attacks of up to Power rank range and damage. Sonic attacks are made on the force column, and can initially affect only one target at a time. ",
    },
    {
        category: "Distance Attacks",
        maxRoll: 70,
        ...
        description:
            "The hero possesses a weapon, energy bolt, or Power that either inflicts damage on the Force column, or inflicts a Stunning attack of Power rank Intensity. One of the two types must be chosen at start, though the other may be developed as a Power Stunt. Range and damage are determined by the Power rank, though damage and effects may be voluntarily reduced. ",
    },
    {
        category: "Distance Attacks",
        maxRoll: 80,
    ...
    },
    {
        ...
        bonusPowerCount: 2,
        bonusPower:
            "Mental Powers\\Mind Control(50)|Mental Powers\\Emotion Control(100)",
    },
    {
        category: "Mental Powers",
        maxRoll: 40,
    ...
    },
    {
        ...
        name: "Psionic Attack",
        description:
            "This Power gives the hero the ability to project psionic force blasts at Power rank range and Intensity. The target of this attack must make a successful Psyche FEAT or be knocked unconscious for 1-10 rounds. Charactors with Mental Powers may use their Power ranks instead of Psyche, and those with Psi-Screen should use that Power rank before any other. Force Field's operate against psionic attack. ",
        bonusPowerCount: 4,
        bonusPower:
            "Mental Powers\\Precognition(25)|Mental Powers\\Postcognition(50)|Mental Powers\\Plant Control(75)|Mental Powers\\Ultimate Skill(100)",
    },
    {
        category: "Mental Powers",
        maxRoll: 110,
    ...
    },
    {
        ...
        powerCount: 2,
        description:
            "Emotion Control is a related form of Mind Control that acts upon 82 TM the subconscious fears and attractions to produce the required results. Targets of an Emotion Control attack must be in the same area as the character with this Power, and may make an Intuition FEAT to avoid the effects, which have a duration of 10-100 turns after the initial attack. The effects must diminish before another dose of Emotion Control may be applied. Robots and non-human alien beings are immune to the effects of Emotion Control. Only one type of emotion may be instilled in a target at a time. The character with this Power may modify any emotions, but gains a +2CS if he chooses to modify one emotion exclusively. Such a character is extremely powerful, but may not develop other types of Emotion Control as Power Stunts. Those heroes that do not limit themselves to one particular emotion begin play with two emotions they can modify, with others that may be developed as Emotions may be influenced to reflect on the user of the Power, or on another target. ",
    },
    {
        category: "Mental Powers",
        maxRoll: 130,
    ...
    },
    {
        ...
        name: "Postcognition",
        description:
            "The reverse of Precognition, but easier to handle, in that the past is fairly immutable. Postcognition only works on items the character handles. The Postcog makes a Power rank FEAT, the color required determined by the length of time scanned.",
    },
    {
        category: "Mental Powers",
        maxRoll: 200,
    ...
    },
    {
        ...
        name: "Ultimate Skill",
        description:
            "Ultimate Skill is a special Power possessed by the hero, making him literally 'the best at what he does.' The hero picks any one Talent on the following list. His ability in that Talent is considered Unearthly, as opposed to modifying the existing ability by a + 1 or + 2CS. ",
    },

    {
        ...
        description:
            "The hero who gains this Power when the character is generated may choose the type and number of body parts. Some of these parts may provide Bonus Powers.",
    },
    {
        category: "Body Alterations/Offensive",
        maxRoll: 40,
    ...
    },
    {
        ...
        description:
            "Those touched by an individual with this Power must make an Endurance FEAT against this Power rank, or be knocked out for 1-10 rounds. This Power is always in operation, and the user may be knocked out himself by such a touch.",
    },
    {
        category: "Body Alterations/Offensive",
        maxRoll: 80,
    ...
    },
    {
        ...
        description:
            "Similar to Rotting Touch, but affects inorganic materials instead. The character inflicts Power rank - 3CS damage to living targets, affects organic materials with greatly reduced damage (as for living targets), and acts on inorganic material as if breaking it with Power rank Strength. Resistance to Corrosives will offset these effects. Similar to Claws, this may chew through inorganic Body Armor to affect the individual beneath. ",
        bonusPowerCount: 2,
        bonusPower:
            "Body Alterations/Offensive\\Health-Drain Touch(50)|Body Alterations/Offensive\\Blinding Touch(100)",
    },
    {
        category: "Body Alterations/Offensive",
        maxRoll: 110,
        name: "Health-Drain Touch",
        powerCount: 2,
        description:
            "The touch of a character with this Power transfers a Power rank amount of Health from the target to the hero. Previous damage is healed in an equal amount, up to the maximum Health of the character. Drained Health above that point is lost. Charactors drained to 0 Health must make an Endurance FEAT to avoid dying. If they do so, the attack has no further effect. Reversing this process, directing one's own Health into others, is a Power Stunt. ",
    },
    {
        category: "Body Alterations/Offensive",
        maxRoll: 120,
    ...
    },
    {
        ...
        name: "Pheromones",
        description:
            "Pheromones are a specialized form of Emotion Control that affect the pleasure centers of the...ah...opposite sex. When this Power is in operation, female individuals (if the hero s male) or male individuals (if the hero is female) must make a Psyche FEAT against the Power rank number of this Power as Intensity or be considered Friendly to the character. Robots, aliens, and those unable to smell or be affected by the pheromones (behind a force field, for example) are not affected. Charactors that are Hostile will still be attracted to the character, but that attraction will not stop them from putting the hero in a deathtrap, from which the only release is for the hero to profess his love for the Hostile character and join her in crime. ",
    },
    {
        category: "Body Alterations/Defensive",
        maxRoll: 120,
...
const TALENT_LIST_ADVANCED_TABLE = [
    ...
    },
    {
        ...
        name: "Thrown Weapons",
        description:
            "Charactors with this Talent toss weapons designed to be thrown (including spears, daggers, shuriken, disks, and snowballs)",
    },
    {
        category: "Weapon Skills",
        maxRoll: 60,
    ...
    },
    {
        ...
        name: "Blunt Weapons",
        description:
            "Charactors with this Talent gain a + 1CS to hit when attacking with a blunt weapon.",
    },
    {
        category: "Weapon Skills",
        maxRoll: 90,
        name: "Sharp Weapons",
        description:
            "Charactors with this Talent gain a + 1CS to hit when attacking with a sharp weapons.  This includes swords, daggers (unless thrown), and spears, but excludes claws and other natural extensions that inflict this type of damage.",
    },
    {
        category: "Weapon Skills",
        maxRoll: 100,
