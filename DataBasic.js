...
const PHYSICAL_FORM_TABLE = [
    {
        ...
        column: 1,
        description:
            "Mutants derive their powers from changes in their genetic structure. These changes become evident during adolescence.",
    ...
    },
    {
        ...
        column: 1,
        description:
            "Altered humans were once normal humans. Exposure to powerful chemicals, radiation, magic, cosmic, or unknown forces changed them and gave them their powers.",
    ...
    },
    {
        ...
        column: 3,
        description:
            "Hi-tech wonders are normal humans whose powers come from advanced technology. Their powers are built into their suits and devices, so the heroes may be very weak without their equipment.",
        isHiTech: true,
        reasonAdjustment: 1,
        bonusPowerCount: 1,
        bonusPower:
            "Weapons, Vehicles, Sidekicks, and Alter Egos\\Alter Ego(100)",
    },
    {
        maxRoll: 95,
        name: "Robot",
        column: 4,
        description:
            "Robots are machines, computers, cyborgs, androids, or golems. All robots must be created by someone or something, either intentionally or by accident.",
...
const QUANTITY_TABLE = [
    {
        maxRoll: 20,
        powers: { initial: 2, maximum: 2 },
        talents: { initial: 1, maximum: 1 },
        contacts: { initial: 0, maximum: 0 },
    },
    {
        maxRoll: 60,
        powers: { initial: 3, maximum: 3 },
        talents: { initial: 2, maximum: 2 },
        contacts: { initial: 1, maximum: 1 },
    },
    {
        maxRoll: 90,
        powers: { initial: 4, maximum: 4 },
        talents: { initial: 3, maximum: 3 },
        contacts: { initial: 2, maximum: 2 },
    },
    {
        maxRoll: 100,
...
const POWER_LIST_TABLE = [
    ...
    {
        category: "Resistances and Senses",
        maxRoll: 11,
        name: "Resistance to Fire",
        description:
            "Resistance is the ability to withstand an attack, suffering less damage than the attack normally would cause. Each resistance is effective against only one type of attack. Heroes may, at the option of the Judge, devise a new resistance of their own, rather than choosing one of those listed.",
    },
    {
        category: "Resistances and Senses",
        maxRoll: 22,
    ...
    },
    {
        ...
        name: "Infravision",
        description:
            "Infravision is the ability to see in complete darkness. A hero with infravision adds 1 to his initiative die rolls in the dark, and operates in the dark with no handicaps of any kind.",
    },
    ...
    // === Movement (Category 06-10) ===
    {
        ...
        name: "Flight",
        description:
            "The hero can fly, through some natural power, technological device, or magic. The flight power rank determines how fast the hero can fly; consult Table 10: Speed, in the Vehicles section. The hero must make a flight FEAT roll to perform intricate maneuvers or fight while aloft.",
    },
    {
        category: "Movement",
        maxRoll: 33,
        name: "Gliding",
        description:
            "The hero can glide by catching updrafts or launching himself from a height. This is not self-propelled flight. The hero can travel up to four areas per round, but must come to a rest at the end of the round; he cannot remain aloft. Like flight, a gliding FEAT roll is required for quick or delicate maneuvering.",
    },
    {
        category: "Movement",
        maxRoll: 50,
    ...
    },
    {
        ...
        name: "Wall-Crawling",
        description:
            "The hero can use suction cups, magnetics, adhesion, or some other power to cling to and move along surfaces from which normal people would fall. A wall-crawling FEAT roll is needed only if the hero is on a slippery or wet surface, or performing acrobatics.",
    },
    {
        category: "Movement",
        maxRoll: 83,
    ...
    },
    {
        ...
        name: "Teleportation",
        description:
            "Teleportation is a special type of movement that allows a hero to travel instantaneously from one spot to another without physically crossing any of the space between. The hero can teleport across a number of areas equal to his teleportation power rank number. The hero must be familiar with the area he is teleporting to, or be able to see it. He must make a teleportation FEAT roll every time he teleports; failure means the hero arrives dazed and unable to take any further action until the end of the next round. If a hero teleports into a solid object (because he was unaware of its presence), he must make an Endurance FEAT roll; if this roll fails, he dies immediately. If it succeeds, he instinctively teleports himself back to his starting location, and is dazed for the next 1 to 10 rounds.",
    },
    ...
    // === Energy Control (Category 21-35) ===
    {
        ...
        description:
            "A hero with magnetic control can control any items that contain iron or steel. The hero also can manipulate Earth's magnetic field and use it to control iron or steel-bearing items, or create a magnetic force shield with an armor rank equal to the magnetic control power rank. In all cases, the power rank determines how well the hero can manipulate energy, and how much damage an energy attack can inflict. A hero can affect his area and adjacent areas with ease. Affecting anything two or more areas away requires an Endurance FEAT roll.",
    },
    {
        category: "Energy Control",
        maxRoll: 33,
    ...
    // === Body Control (Category 36-45) ===
    {
        ...
        name: "Growth",
        description:
            "The hero can grow taller at will. The limit on his size is listed on Table 31: Size Changes, and depends on the power rank. If the hero's Strength rank is less than this power rank, he uses the power rank as his Strength when in giant form. If the power rank is less than the hero's Strength, the hero's Strength is increased one rank when in giant form. Enemies who attack him also get a one-column shift to the right, because the hero's great size makes him easier to attack.",
    },
    {
        category: "Body Control",
        maxRoll: 25,
        name: "Shrinking",
        description:
            "The hero can make himself smaller. The limit depends on his shrinking power rank, and is listed on Table 31: Size Changes. The hero's Strength rank is unaffected by size reduction, but he gets a one-column shift to the right when attacking, and opponents have a two-column shift to the left when they attack him.",
    },
    {
        category: "Body Control",
        maxRoll: 38,
    ...
    },
    {
        ...
        name: "Plasticity",
        description:
            "A hero with this power can stretch sections of his body, like Mr. Fantastic of the Fantastic Four. This power allows the hero to punch or grab someone in another area. The stretching limit is determined by the power rank: Feeble 1 area, Poor to Excellent 2 areas, Remarkable or better 3 areas.",
    },
    {
        category: "Body Control",
        maxRoll: 88,
        name: "Shape-Shifting",
        description:
            "The hero can change to the shape of any animal, plant, or object he wishes. He retains his normal size and mass, unless he also has growth or shrinking power. Changes to a generic shape are automatic, but to become a perfect duplicate of a specific object requires a shape-shifting FEAT roll.",
    },
    {
        category: "Body Control",
        maxRoll: 100,
    ...
    // === Distance Attacks (Category 46-60) ===
    {
        ...
        maxRoll: 13,
        name: "Hi-Tech Missile Weapon",
        description:
            "Hi-tech missile weapons can be hand-held or implanted in the hands. The Judge and the player can agree to give such weapons specialized effects, similar to Hawkeye's stun arrows. A new hero should not have more than three specialized hi-tech items, and none of them can exceed the power rank of this power. Any attack with these powers is an Agility FEAT, but damage caused equals the power rank number.",
    },
    {
        category: "Distance Attacks",
        maxRoll: 25,
        name: "Ensnaring Missile Weapon",
        description:
            "An ensnaring attack causes no damage, but immobilizes the target by tangling. The material that entangles the target has a material rank equal to this power rank. The ensnared character can try to break free only if his Strength rank equals or exceeds the material rank. Any attack with these powers is an Agility FEAT, but damage caused equals the power rank number.",
    },
    {
        category: "Distance Attacks",
        maxRoll: 38,
        name: "Mental Force",
        description:
            "The hero has the power to launch a psionic blast, directly attacking his opponent's mind. The blast causes damage equal to the power rank. A mental attack is a Psyche FEAT, not an Agility FEAT.",
    },
    {
        category: "Distance Attacks",
        maxRoll: 50,
        name: "Cold Missile Weapon",
        description:
            "Cold, Energy, Fire, Sound, and Darkforce energies can be directed against a specific target, causing damage equal to the power rank. If the hero also has the power to control this energy, it can be modified for different effects. Any attack with these powers is an Agility FEAT, but damage caused equals the power rank number.",
    },
    {
        category: "Distance Attacks",
        maxRoll: 63,
        name: "Energy Missile Weapon",
        description:
            "Cold, Energy, Fire, Sound, and Darkforce energies can be directed against a specific target, causing damage equal to the power rank. If the hero also has the power to control this energy, it can be modified for different effects. Any attack with these powers is an Agility FEAT, but damage caused equals the power rank number.",
    },
    {
    ...
    },
    {
        ...
        powerCount: 2,
        description:
            "Heroes with this power can create images of anything imaginable by making a power FEAT roll. These images look, sound, and smell entirely real. When a defender first encounters such an image, the Judge makes a secret Psyche FEAT roll for him. If the FEAT succeeds, the defender cannot be affected by the image because it has no substance. If the FEAT failed, the defender believes the image can harm him. Attacks are treated as if the image were real, but the image cannot kill anyone. A person with this power can control only one image at a time, and must concentrate on that image to maintain it. A person cannot defend himself and control the image during the same round. If attacked, he must make a Psyche FEAT roll to maintain the image.",
    },
    {
        category: "Mental Powers",
        maxRoll: 50,
        name: "Telekinesis",
        description:
            "A hero with telekinetic power can move objects with his mind. The telekinetic power rank determines how much weight can be moved, as if it were Strength. The hero can also ensnare someone telekinetically; the victim is considered trapped by a material with a rank equal to the attacker's telekinetic power rank or Psyche rank. The hero can form a telekinetic fist and attack from a distance, making a Psyche FEAT roll to hit his target. This will cause damage equal to the attacker's power rank.",
    },
    {
        category: "Mental Powers",
        maxRoll: 67,
    ...
    // === Body Alterations, Offensive (Category 66-80) ===
    {
        ...
        description:
            "This is either duplication of a normal body component (a second set of arms, for example) or addition of a new component (perhaps a prehensile tail). These additional parts do not allow the hero to attack more often unless he also has the Extra Attacks power.",
    },
    {
        category: "Body Alterations, Offensive",
        maxRoll: 40,
        name: "Extra Attacks",
        description:
            "The hero can attack twice in one round. The attacks can be against the same or different opponents. The hero must have some explanation for his extra attack: extra body parts, fantastic speed, or a hi-tech item that can be used more than once per round.",
    },
    {
        category: "Body Alterations, Offensive",
        maxRoll: 60,
    ...
    },
    {
        ...
        name: "Claws",
        description:
            "The hero has claws. When attacking, the hero can use his Fighting rank or this power rank, whichever he prefers. Damage equals the hero's Strength rank plus one column, and attacks are resolved on the Hack & Slash column.",
    },
    ...
    // === Body Alterations, Defensive (Category 81-95) ===
    {
        ...
        name: "Body Armor",
        description:
            "The hero has body armor equal to this power rank. The player must decide how this armor works, and how it affects the hero's appearance. This power reduces the hero's Agility by one rank.",
    },
    {
        category: "Body Alterations, Defensive",
        maxRoll: 100,
        name: "Regeneration",
        description:
            "Heroes with this power regain lost Health points faster than normal. The hero recovers as if his Endurance equalled this power rank, or his Endurance plus one rank, whichever is higher.",
    },

    // === Weapons, Vehicles, Sidekicks, and Alter Egos (Category 96-00) ===
    {
        category: "Weapons, Vehicles, Sidekicks, and Alter Egos",
        maxRoll: 20,
        name: "Unique Weapon",
        description:
            "The hero has a unique weapon, similar to Captain America's shield or Thor's hammer. The hero gets two column shifts to the right when using this weapon in combat. The weapon also has one super power, chosen by the player. Its power rank is determined randomly, but if the result is Good or less, increase it to Excellent.",
    },
    {
        category: "Weapons, Vehicles, Sidekicks, and Alter Egos",
        maxRoll: 40,
...
const TALENT_LIST_TABLE = [
    // Basic Rules Table 30: Talents (25 talents, 4% each)
    {
        ...
        name: "Guns",
        description:
            "Each of these separate talents gives the attacker one column shift to the right when using the named weapon type in combat.",
    },
    {
        category: "Talents",
        maxRoll: 8,
    ...
    },
    {
        ...
        name: "Marksman",
        description:
            "The user gets one column shift to the right when using any weapon that requires an Agility FEAT.",
    },
    {
        category: "Talents",
        maxRoll: 24,
        ...
        talentCount: 2,
        description:
            "The user gets one column shift to the right when using any weapon that requires a Fighting FEAT.",
    },
    {
        category: "Talents",
        maxRoll: 28,
        name: "Martial Arts",
        description:
            "The user can slam or stun an opponent, even if the opponent has a higher Strength rank.",
    },
    {
        category: "Talents",
        maxRoll: 32,
        name: "Wrestling",
        description:
            "The hero gets two column shifts to the right when wrestling, but this does not affect damage.",
    },
    {
        category: "Talents",
        maxRoll: 36,
        name: "First Aid",
        description:
            "A person who knows first aid can help a hero who is unconscious and losing Endurance ranks. If first aid is applied within 10 rounds after the hero is wounded, the loss of Endurance ranks may be halted.",
    },
    {
        category: "Talents",
        maxRoll: 40,
    ...
    },
    {
        ...
        name: "Law",
        description:
            "This person is a lawyer, and is familiar with all aspects of the law. The hero is shifted one column to the right when dealing with legal matters.",
    },
    {
        category: "Talents",
        maxRoll: 48,
    ...
    },
    {
        ...
        name: "Aeronautics",
        description:
            "A person with this talent has a pilot's license, and can pilot any normal aircraft. This does not include spacecraft.",
    },
    {
        category: "Talents",
        maxRoll: 56,
        name: "Military",
        description:
            "The hero is an active or retired member of the armed forces. When dealing with the military, the hero gets a one-column Reason shift to the right and a temporary 10-point bonus to his Popularity.",
    },
    {
        category: "Talents",
        maxRoll: 60,
        ...
        description:
            "This hero is familiar with the world of business and corporate finance. Reason is shifted one column right when dealing with business practices and money.",
    },
    {
        category: "Talents",
        maxRoll: 64,
        name: "Scholar",
        description:
            "Scholars get a one-column shift to the right when dealing with any subject they have studied. The Judge should use his knowledge of the character to decide whether a character has studied a particular subject.",
    },
    {
        category: "Talents",
        maxRoll: 68,
        name: "Journalism",
        description:
            "The hero has contacts at local newspapers, radio, or television stations. He also knows people in politics, police departments, and the underworld.",
    },
    {
        category: "Talents",
        maxRoll: 72,
        name: "Engineering",
        description:
            "Engineers receive one column shift to the right when inventing or building any device.",
    },
    {
        category: "Talents",
        maxRoll: 76,
        name: "Chemistry",
        description:
            "These talents allow a bonus shift of one column to the right when using Reason to deal with a problem within this field, including inventing and building items.",
    },
    {
        category: "Talents",
        maxRoll: 80,
...
const CONTACT_CATEGORIES_TABLE = [{ maxRoll: 100, name: "Contact" }];
