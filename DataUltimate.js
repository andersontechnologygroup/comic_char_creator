...
const PHYSICAL_FORM_ULTIMATE_TABLE = [
    ...
    },
    {
        ...
        description:
            'The hero started life as a Normal Human, "then something happened." As a result of a freak happenstance, the hero has been physically and genetically altered.',
    },
    {
        maxRoll: 33,
        name: "Mutant - Random",
        ...
        description:
            "The hero was born to Normal Humans, but a freak twist of genetic fate made him a mutant from birth.",
    },
    {
        maxRoll: 35,
        name: "Mutant - Breed",
        ...
        description:
            "The hero's parents were Mutants, as were any number of preceding generations. Breed Mutants form tribes and have close-knit families; this is a defense mechanism born from generations spent hiding their true selves from normal society.",
    },
    {
        maxRoll: 38,
        name: "Android",
    ...
    },
    {
        ...
        description:
            "The hero was created in an operating room. His body contains parts taken from several bodies. Close examination reveals the scars from his creation.  Resistance to Mental Domination is reduced -1CS.  Composites heal twice as quickly as Normal Humans.",
    },
    {
        maxRoll: 49,
    ...
    },
    {
        ...
        column: 2,
        description:
            "This type of body is harder to disguise than the other Modifications because the body now possesses extra pieces of anatomy.  These may be duplicates of normal parts (arms are probably the most common example), or parts that are not found on a Normal Human.  Arms raise Fighting + 1CS.  Duplicate organs doubles the Health point total.  Tails give the hero an additional attack when engaged in blunt attacks (one per tail).  Wings give the hero Flight. ",
    },
    {
        maxRoll: 58,
        name: "Demihuman - Centaur",
        column: 5,
        description:
            "Demihumans can be unique individuals or members of a race that inhabits a different place or time.  Centaurs have a human head, torso, and arms mated to the body of a horse.  They can move quickly over horizontal ground (four areas/turn), and can fight with their hooves. On the minus side, centaurs have Feeble Climbing ability.  They are popularly thought of as scholars or drunken lechers.",
    },
    {
        maxRoll: 59,
        name: "Demihuman - Equiman",
        column: 3,
        description:
            "Demihumans can be unique individuals or members of a race that inhabits a different place or time.  Equimen possess horse legs in place of human ones. They have a horse's mane and tail as well.  By hiding the legs and tail, an equiman can pass for human. Kicking does + 1CS damage.",
    },
    {
        maxRoll: 60,
        name: "Demihuman - Faun",
        column: 2,
        description:
            "Demihumans can be unique individuals or members of a race that inhabits a different place or time.  Fauns possess the hairy legs, short tail, and horns of a goat.  They possess Feeble Mental Domination over females of any human(oid) race",
    },
    {
        maxRoll: 62,
        name: "Demihuman - Felinoid",
        column: 1,
        description:
            "Demihumans can be unique individuals or members of a race that inhabits a different place or time.  Felinoids are human-shaped, cat- like beings. The overall body shape is human, but the skin is covered in fur and the face is that of a cat. A felinoid has a tail, claws, fangs, pointed ears on top of the head, and slitted pupils in the eyes. A felinoid can see in the dark with Excellent night vision. Such beings possess + 1CS Climbing ability.",
    },
    {
        maxRoll: 63,
        name: "Demihuman - Lupinoid (Werewolf)",
        column: 4,
        popularityAdjustment: -1,
        description:
            "Demihumans can be unique individuals or members of a race that inhabits a different place or time.  Lupinoids are human-shaped, canine-like beings. They are often mistaken for the cinematic conception of a werewolf. The body is covered in hair and the face is definitely canine. The body has a tail, harmless claws, big teeth, and long pointed ears atop the head. A lupinoid possesses an Excellent sense of smell.",
    },
    {
        maxRoll: 64,
        name: "Demihuman - Lupinoid",
        column: 4,
        description:
            "Demihumans can be unique individuals or members of a race that inhabits a different place or time.  Lupinoids are human-shaped, canine-like beings. They are often mistaken for the cinematic conception of a werewolf. The body is covered in hair and the face is definitely canine. The body has a tail, harmless claws, big teeth, and long pointed ears atop the head. A lupinoid possesses an Excellent sense of smell.",
    },
    {
        maxRoll: 65,
        name: "Demihuman - Avian (Angelic)",
        column: 3,
        popularityAdjustment: 1,
        description:
            "Demihumans can be unique individuals or members of a race that inhabits a different place or time.  Angelic avians resemble humans with wings sprouting from the shoulder blades. Angelic avians reproduce by normal human means.",
    },
    {
        maxRoll: 66,
        name: "Demihuman - Avian (Harpie)",
        column: 2,
        fightingAdjustment: 1,
        description:
            "Demihumans can be unique individuals or members of a race that inhabits a different place or time.  Harpies possess arms that are modified to also serve as wings and feather-covered legs that end in bird claws. Harpies reproduce by laying eggs.",
    },
    {
        maxRoll: 67,
        name: "Demihuman - Chiropteran",
        column: 2,
        popularityStart: 1 /* Feeble */,
        bonusPowerCount: 1,
        bonusPower: "Detection\\Sonar (Active)\\Good(100)",
        description:
            "Demihumans can be unique individuals or members of a race that inhabits a different place or time.  Chiropterans are similar to angelic humans except that they combine the human parts with those of a bat. Their arms also serve as leathery wings, their feet have elongated toes that can serve as hands, and in addition they possess large ears.",
    },
    {
        maxRoll: 68,
        name: "Demihuman - Lamian",
        column: 3,
        popularityStart: 0,
        description:
            "Demihumans can be unique individuals or members of a race that inhabits a different place or time.  Lamians are snake people. The legs have been replaced by a serpentine body, although the arms are normal. The skin is covered in fine scales. Lamians have lidless eyes and retractable fangs.  Lamians are difficult to bind (+ 1CS toescape).",
    },
    {
        maxRoll: 69,
        name: "Demihuman - Merhuman",
        column: 2,
        popularityAdjustment: 1,
        bonusPowerCount: 1,
        bonusPower: "Physical Enhancement\\Water Freedom(100)",
        description:
            "Demihumans can be unique individuals or members of a race that inhabits a different place or time.  Merhumans are amphibious relatives of lamians. The body is human from the waist up; the rest is a flexible fish-tail. Merhumans possess both lungs and gills, but can only stay away from water a limited time because their bodies quickly dry out. Movement on dry land is limited to crawling or dependence on vehicles.",
    },
    {
        maxRoll: 70,
        name: "Demihuman - Other",
        column: 3,
        description:
            "Demihumans can be unique individuals or members of a race that inhabits a different place or time.",
    },
    {
        maxRoll: 72,
        name: "Cyborg - Artificial limbs/organs",
        column: 2,
        intuitionAdjustment: -1,
        description:
    ...
    {
        maxRoll: 82,
        name: "Robot - human shape",
        column: 4,
        popularityStart: 0,
        description:
            "This is a completely mechanical being that is patterned after the human body. ",
    },
    {
        maxRoll: 84,
        name: "Robot - Usuform",
        column: 4,
        description:
            'This is a robot that believes in the age of "Form follows function." This robot\'s body is anything but humanshaped and is designed to best serve specific needs. ',
    },
    {
        maxRoll: 86,
    ...
    },
    {
        ...
        name: "Angel/Demon",
        column: 5,
        subType: "Angel(50)|Demon(100)",
        popularityAdjustment: "Angel(+2)|Demon(-2)",
        allPhysicalAbilitiesAdjustment: 1,
        bonusPowerCount: 1,
        bonusPower:
            "Demon(Energy Emission\\Fire Generation\\Good(100))|Angel(Matter Creation\\Artifact Creation\\Good(100))",
        description:
            'These are magical beings from other planes of existence. They are both supernatural and corporeal in nature. The main difference between these types is their inherent personality. "Angels" are benevolent; "demons" are malevolent. Other than that, there isn\'t much differnce.  Such beings p o s s e s s a Psychological Weakness that Negates their Power.',
    },
    {
        maxRoll: 89,
        name: "Deity",
        column: 5,
        powersCountAdjustment: 2,
        popularityAdjustment: 2,
    ...
    },
    {
        ...
        description:
            "This is a catch-all category that includes fish, mammals, birds, reptiles, and the rest of Earth's fauna, in addition to aliens that do not fit into any other category.",
    },
    {
        maxRoll: 91,
        name: "Vegetable",
        ...
        description:
            "The hero is an intelligent, mobile plant. He can be of any nature but for game purposes the hero is assumed to be a man-shaped plant. His physiology is based on photosynthesis. The plant-man doesn't need to eat anything except a bit of fertilizer occasion- ally. Prolonged deprivation of light and water reduces the hero's Strength and Endurance - 1CS per day after an initial three days.",
    },
    {
        maxRoll: 92,
        name: "Abnormal Chemistry",
        column: 2,
        enduranceAdjustment: 1,
        description:
            "The body is apparently normal but possesses a different chemical base than that of Normal Humans. A key element in the body's chemical makeup is replaced by another element. The most common abnormali- ties are silicon replacing carbon, copper replacing iron, and cobalt replacing iron.",
    },
    {
        maxRoll: 93,
        name: "Mineral",
    ...
    },
    {
        ...
        column: 1,
        description:
            "The hero is an intangible, disembodied spirit. He can be a ghost who once possessed a mortal shell, or belong to a race that always exists in this form. ",
    },
    {
        maxRoll: 98,
        name: "Undead",
    ...
    },
    {
        ...
        description:
            "The hero's body contains aspects of two or more of the preceding Body Types. As such, it possesses a mixture of the advantages and disadvantages of each type.",
    },
    {
        maxRoll: 100,
        name: "Changeling",
        column: 5,
        description:
            "The hero can transform into any of a number of possible Body Types. Each Body Type aspect of the Changeling possesses its regular advantages and disadvantages which apply only when the hero is in that particular form.  Each Aspect must have one Power which is unique to it, a Power no other Aspect has.",
    },
];
...
const ORIGIN_ULTIMATE_TABLE = [
    {
        ...
        name: "Natal",
        description:
            "The hero was born in the Body Type he has, and possessed all his Powers from birth onward (although learning to control them took time). ",
    },
    {
        maxRoll: 20,
        name: "Maturity",
        description:
            "The hero gained his Powers sometime after reaching adulthood. Powers may have begun manifesting themselves sporadically during adolescence, or even childhood, but full control wasn't achieved until maturity. ",
    },
    {
        maxRoll: 30,
        name: "Self-Achievement",
        description:
            "The hero actively sought out a means of giving himself Power. He developed the methods, procedures, equipment, or whatever permits him to possess Power. ",
    },
    {
        maxRoll: 35,
        name: "Endowment",
        description:
            "The hero was given his Power by another being. This includes such diverse situations as being transformed, being charged with Power, and acquiring an item whose possession gives the hero Power.",
    },
    {
        maxRoll: 50,
        name: "Technical Mishap",
        description:
            "GThe hero was caught in an experiment or procedure gone awry, with the result that the hero gained Powers that were totally unexpected. Such freak conditions cannot be completely duplicated, although they can be simulated.",
    },
    {
        maxRoll: 60,
        name: "Technical Procedure",
        description:
            "The hero was the subject of a controlled scientific or magical experiment. Assuming that all the factors are reproduced, such a Technical Experiment should be able to produce a steady supply of super-powered heroes.  Unfortunately, the geniuses behind such experiments often leave inadequate notes.",
    },
    {
        maxRoll: 65,
        name: "Creation",
        description:
            "The hero was born in the form he now has, that of an adult who possesses Power and/or whatever the Body Type is.",
    },
    {
        maxRoll: 76,
        name: "Biological Exposure",
        description:
            "The hero gained Power after exposure to a special life-form or a substance secreted by that lifeform.",
    },
    {
        maxRoll: 87,
        name: "Chemical Exposure",
        description:
            "The hero was transformed by exposure to an exotic element, compound, or mixture. This substance can be inhaled, ingested, injected, or just placed next to the hero for it to affect him.",
    },
    {
        maxRoll: 98,
        name: "Energy Exposure",
        description:
            "The hero was exposed to a special form and Intensity of energy — anything out of the ordinary will do - and turned into his present self.",
    },
    {
        maxRoll: 100,
        name: "Rebirth",
        description:
            "The hero was once a perfectly ordinary person. Then he died. Something happened to him that destroyed his old body and gave him a new one, complete with Power.",
    },
];
...
const QUANTITY_ULTIMATE_TABLE = [
    {
        maxRoll: 12,
        powers: { initial: 1, maximum: 3 },
        talents: { initial: 0, maximum: 3 },
        contacts: { initial: 0, maximum: 2 },
    },
    {
        maxRoll: 26,
        powers: { initial: 2, maximum: 4 },
        talents: { initial: 1, maximum: 4 },
        contacts: { initial: 0, maximum: 4 },
    },
    {
        maxRoll: 41,
        powers: { initial: 3, maximum: 5 },
        talents: { initial: 1, maximum: 6 },
        contacts: { initial: 1, maximum: 4 },
    },
    {
        maxRoll: 55,
        powers: { initial: 4, maximum: 6 },
        talents: { initial: 2, maximum: 4 },
        contacts: { initial: 2, maximum: 4 },
    },
    {
        maxRoll: 66,
        powers: { initial: 5, maximum: 7 },
        talents: { initial: 2, maximum: 6 },
        contacts: { initial: 2, maximum: 6 },
    },
    {
        maxRoll: 75,
        powers: { initial: 2, maximum: 8 },
        talents: { initial: 2, maximum: 8 },
        contacts: { initial: 3, maximum: 3 },
    },
    {
        maxRoll: 83,
        powers: { initial: 7, maximum: 9 },
        talents: { initial: 3, maximum: 4 },
        contacts: { initial: 3, maximum: 4 },
    },
    {
        maxRoll: 89,
        powers: { initial: 8, maximum: 10 },
        talents: { initial: 3, maximum: 6 },
        contacts: { initial: 3, maximum: 6 },
    },
    {
        maxRoll: 94,
        powers: { initial: 9, maximum: 12 },
        talents: { initial: 4, maximum: 8 },
        contacts: { initial: 4, maximum: 4 },
    },
    {
        maxRoll: 97,
        powers: { initial: 10, maximum: 12 },
        talents: { initial: 4, maximum: 4 },
        contacts: { initial: 4, maximum: 5 },
    },
    {
        maxRoll: 99,
        powers: { initial: 12, maximum: 14 },
        talents: { initial: 5, maximum: 6 },
        contacts: { initial: 5, maximum: 5 },
    },
    {
        maxRoll: 100,
        powers: { initial: 14, maximum: 18 },
        talents: { initial: 6, maximum: 8 },
        contacts: { initial: 6, maximum: 6 },
    },
];
...
const WEAKNESS_STIMULUS_ULTIMATE_TABLE = [
    {
        ...
        name: "Psychological",
        description:
            "A specific event, condition, or mental state has an adverse effect on the hero. This Stimulus directly affects the hero's mind; any resulting physical damage is psychosomatic in nature. That is, any physical damage results are due to the hero's instinctive belief in those results.",
    },
    {
        maxRoll: 18,
        name: "Elemental Allergy",
        description:
    ...
    {
        maxRoll: 43,
        name: "Molecular Allergy",
        description:
            "The hero suffers adverse effects if he is exposed to a specific molecules. This Allergy only occurs if the molecule is present in a pure state and in an accumulation of at least one ounce.",
    },
    {
        maxRoll: 68,
        name: "Energy Allergy",
        description:
            "The hero suffers when he is exposed to a specific form of energy. This can be any wavelength or Intensity of energy found in the Energy Emission and Energy Control sections of this book.",
    },
    {
        maxRoll: 81,
        name: "Energy Depletion",
        description:
            "The hero has a finite energy supply that permits him to manifest Power. This energy must be periodically renewed by means of rest, food, Energy Absorption, Energy Vampirism, or simply making contact with a source of that energy.",
    },
    {
        maxRoll: 94,
        name: "Energy Dampening",
        description:
            "The hero has the problem of having to release the energy pent up within himself; this is done by using his Powers. ",
    },
    {
        maxRoll: 100,
        name: "Finite Limit",
        requiredRankNumber: true,
        description:
            "All of the hero's Powers have a finite number of times they can be used. This is determined by a second, independent Power rank roll; this rank number is the number of uses remaining for that Power.",
    },
];
...
const WEAKNESS_EFFECT_ULTIMATE_TABLE = [
    ...
    },
    {
        ...
        name: "Incapacitation",
        description:
            "The hero becomes physically ill after exposure to the Stimulus. Beginning with the initial contact, the hero loses one point of Health per turn.",
    },
    {
        maxRoll: 100,
        name: "Fatal",
        description:
            "As in the above, the hero gets ill after the initial exposure to the Stimulus. However, the Health loss does not stop at zero. ",
    },
];
...
const WEAKNESS_DURATION_ULTIMATE_TABLE = [
    {
        maxRoll: 40,
        name: "Continuous with Contact",
        description:
            "As long as the hero remains within the effective range of the Stimulus, the Effect continues. When the hero is insulated or moved away from the Stimulus, the Effect immediately ceases. ",
    },
    {
        maxRoll: 60,
        name: "Limited Duration with Contact",
        description:
            "The Effect begins immediately upon contact with the Stimulus. However, the Effect only functions for a limited amount of time. After that time elapses, the hero is assumed to have either built up a temporary immunity to the Stimulus or the Stimulus has discharged its Effect. ",
    },
    {
        maxRoll: 90,
        name: "Limited Duration after Contact",
        description:
            "The Effect is continuous with Contact and also lasts for a limited time after the hero is no longer exposed to the Stimulus. ",
    },
    {
        maxRoll: 100,
        name: "Permanent",
        description:
            "The Stimulus does its full damage to the hero, even when exposure to the Stimulus has been interrupted. In this case, the Stimulus sets off a bodily self-destruction sequence that must continue to its full extent.",
    },
];
...
const POWER_LIST_ULTIMATE_TABLE = [
    ...
    },
    {
        ...
        description:
            "The hero has increased resistance to emotion-related attacks via a force field. The Field protects anyone within from attacks that are emotion-related or aimed at the Intuition, including Emotion Control, Hallucinations, and Domination. ",
    },
    {
        category: "Defensive",
        code: "D4",
        ...
        description:
            "The hero has an increased resistance to any emitted energy form, whether artificial, natural, or Power-based via a force field. When creating the hero, the player can raise his rank + 2CS by choosing a field that protects against a specific attack.",
    },
    {
        category: "Defensive",
        code: "D5",
        ...
        description:
            "The hero has increased resistance to magic based attacks, whether physical or mental in orientation via a force field.",
    },
    {
        category: "Defensive",
        code: "D6",
        ...
        description:
            "The hero has increased resistance to attacks aimed at the mind and neural system via force field.  It does not protect against emotion-based attacks or magical attacks.",
    },
    {
        category: "Defensive",
        code: "D7",
    ...
    },
    {
        ...
        description:
            "The hero has increased resistance to attacks that directly affect the hero's Powers via a force field.  The field protects anyone within from any attacks that directly affect the hero's Powers, including Weakness Creation, Power Control, Power Domination, Magic Control, and Magician Domination.",
    },
    {
        category: "Defensive",
        code: "D9",
        ...
        description:
            "The hero has increased resistance to any vampiric-type attacks via a forcee field.  The field protects anyone within from any vampiric-type attacks. This includes the forms of Psi-, Bio-, Energy, Magic, and Power Vampirism.",
    },
    {
        category: "Defensive",
        code: "D10",
        ...
        name: "Reflection",
        description:
            "The hero can turn any attack back onto the attacker. The attack may be of any nature: brute force, Power, or magic. The Power absorbs the energy of the attack up to this rank and redirects it. Normally, this Power is consciously controlled and only appears when the hero wills it.",
    },
    {
        category: "Defensive",
        code: "D11",
        ...
        name: "Resist: Emotion",
        description:
            "The hero has increased resistance to emotion-related attacks. Such attacks include Emotion Control, Hallucinations, Domination, and attacks aimed at the Intuition. ",
    },
    {
        category: "Defensive",
        code: "D12",
        ...
        name: "Resist: Energy",
        description:
            "The hero has an increased resistance to any emitted energy form, whether artificial, natural, or Power-based. Such attacks include Light, Heat, Flame, Plasma, Hard radiation, Electricity, Vibration, Sonics, Cold, and Kinetic Bolts.",
    },
    {
        category: "Defensive",
        code: "D13",
        ...
        name: "Resist: Magic",
        description:
            "The hero has increased resistance to magic based attacks, whether physical or mental in orientation.",
    },
    {
        category: "Defensive",
        code: "D14",
        ...
        name: "Resist: Mental",
        description:
            "The hero has increased resistance to attacks aimed at the mind and neural system. Such attacks include psionics, neural manipulation, and any other attacks aimed at the Psyche. It does not include emotion-based attacks or magical attacks.",
    },
    {
        category: "Defensive",
        code: "D15",
        ...
        description:
            "The hero has increased resistance to any physical attack. This includes brute force, chemical weapons, biochemicals, disease, hostile environments, and temperature extremes. ",
    },
    {
        category: "Defensive",
        code: "D16",
        maxRoll: 97,
        name: "Resist: Power Manipulation",
        description:
            "The hero has increased resistance to attacks that directly affect the hero's Powers. Such attacks include Weakness Creation, Power Control, Power Domination, Magic Control, and Magician Domination. ",
    },
    {
        category: "Defensive",
        code: "D17",
        ...
        description:
            "The hero has increased resistance to any vampiric-type attacks. Such attacks include forms of Psi-, Bio-, Energy, Magic, and Power Vampirism. ",
    },
    ...
    // Detection (DT)
    {
        ...
        description:
            "The hero's senses function in their normal manner, but their normal range of sensitivity is altered. The senses detect what they normally cannot and cannot detect what they normally can. This affects either vision or hearing.",
    },
    {
        category: "Detection",
        code: "DT2",
        ...
        noRank: true,
        description:
            "The hero can see 360 degrees around himself. There are two ways to do this. The first is the hero's eyes are placed far enough apart that they can see in all directions. The second, more socially acceptable method is the hero possesses a weird light warping field that funnels light into his otherwise normal-looking eyes.",
    },
    {
        category: "Detection",
        code: "DT3",
        ...
        description:
            "The hero can detect and identify energy and related phenomena. The power can only detect actual energy, not potential energy. Likewise, while it can detect the energies consciously emitted by superhumans, it cannot detect the superhumans themselves.",
    },
    {
        category: "Detection",
        code: "DT4",
        ...
        description:
            "The hero has increased sensitivity to conditions in, disturbances in, and influences on the environment. The hero automatically maintains full knowledge of current conditions in his surroundings. This awareness extends to such factors as weather, chemicals, movement, and life.",
    },
    {
        category: "Detection",
        code: "DT5",
        ...
        description:
            "The hero can sense across the dimensional barrier and see things existing in other dimensions. The power rank number equals the number of different dimensions into which the hero can see.",
    },
    {
        category: "Detection",
        code: "DT6",
    ...
    },
    {
        ...
        description:
            "The hero can detect the presence of minute traces of substances and accurately identify them. This Power is continually functioning.",
    },
    {
        category: "Detection",
        code: "DT8",
    ...
    },
    {
        ...
        name: "Life Detection",
        description:
            "The hero can detect the presence of life and identify the nature of that life. The hero can probe a specific target for more detailed physiological data on a red FEAT.",
    },
    {
        category: "Detection",
        code: "DT10",
        ...
        description:
            "The hero can detect and identify magic and its effects. The Power can detect both magic in actual use and in potential.",
    },
    {
        category: "Detection",
        code: "DT11",
    ...
    },
    {
        ...
        description:
            'This is commonly called "X-ray vision" but may not actually use X-rays. The hero can see through solids; the effect is as if the obscuring material were transformed to clear glass.',
    },
    {
        category: "Detection",
        code: "DT13",
        ...
        description:
            "The hero can detect and identify superhuman Powers. He can also identify specific superhumans by their characteristic Powers (an Unearthly FEAT). The hero can identify the presence of previously invoked power when examining former targets of Power on a Good Intensity FEAT.",
    },
    {
        category: "Detection",
        code: "DT14",
        ...
        description:
            "The hero can detect and identify psionic Power and related phenomena. It can detect both actual psionics and the potential to use them.",
    },
    {
        category: "Detection",
        code: "DT15",
        ...
        name: "Radarsense",
        description:
            "The hero can gain a three-dimensional picture of his surroundings through the use of electromagnetic waves. The hero both emits and senses these waves. He can use the Power to locate and identify targets by their characteristic echoes.",
    },
    {
        category: "Detection",
        code: "DT16",
        ...
        name: "Sonar (Passive)",
        description:
            "The hero can gain a three-dimensional picture of his environment through the use of soundwaves. The Power allows the hero to locate and identify targets by the way they reflect sound.",
    },
    {
        category: "Detection",
        code: "DT16",
    ...
    },
    {
        ...
        description:
            "The hero's eyes can focus on extremely distant targets, objects too small for normal vision to perceive. The eyes function as telescopes, magnifying normal visual images. With this Power, the hero can see anything in his line of sight, even the surfaces of distant worlds.",
    },
    {
        category: "Detection",
        code: "DT18",
    ...
    },
    {
        ...
        name: "UV Vision",
        description:
            "The hero can see ultraviolet light. Because UV light isn't as readily absorbed by water as normal light, this Power enables the hero to see clearly through fog and at a greater distance in the water (+ 1CS). The hero can also see the dim light given off by radioactive materials.",
    },
    {
        category: "Detection",
        code: "DT22",
        ...
        description:
            "The hero can detect flaws and stress points in a target. This doesn't guarantee he can exploit this knowledge, though.",
    },
    ...
    },
    {
        ...
        description:
            "The hero can control the speed at which chemical reactions occur. He can increase or decrease the energies emitted or drained in such reactions by his Power rank number.",
    },
    {
        category: "Energy Control",
        code: "EC3",
        ...
        optionalPowers:
            "Energy Control\\Thermal Control|Matter Control\\Molding|Self-Alteration\\Body Coating",
        description:
            "The hero can control any force that actively decreases the temperature of something else. This can be used to increase or decrease the cold's Intensity by this Power's rank number. There are two primary functions to this Power. The first is to counteract or supplement cold-based Powers.  The hero can also redirect such Powers. The hero can shape fields of intense cold and produce useful results.",
    },
    {
        category: "Energy Control",
        code: "EC4",
    ...
    },
    {
        ...
        description:
            "The hero can control all forms of electricity, whether natural, artificial, or Power-based. He can control the Intensity and direction of electron streams and alter the conductivity of materials. He can shape electron streams into any desired form. ",
    },
    {
        category: "Energy Control",
        code: "EC6",
        ...
        description:
            "The hero can simply change any form of energy into any other form. The player must determine the characteristics for the secondary Power he gains by taking Energy Conversion.",
    },
    {
        category: "Energy Control",
        code: "EC7",
        ...
        description:
            "The hero can transform energy into a matrix that simulates solid matter. This matrix may be any shape the hero desires, although greater complexity requires a higher Intensity FEAT to create.",
    },
    {
        category: "Energy Control",
        code: "EC8",
    ...
    },
    {
        ...
        description:
            "The hero can control existing flames, whether natural or Power-based. He can alter any factor involved in combustion without direct physical contact. The hero can increase or decrease the flame's Intensity up to his Power rank and reduce fire damage by his rank number. This Power includes Power rank Resistance to Fire and Heat. The most important aspect of this Power is enabling the hero to reshape flame into any form he desires.",
    },
    {
        category: "Energy Control",
        code: "EC11",
    ...
    },
    {
        ...
        bonusPowerCount: 1,
        bonusPower:
            "Mental Enhancement\\Telekinesis(50)|Energy Emission\\Kinetic Bolt(100)",
        optionalPowersMax: 1,
        optionalPowers:
            "Mental Enhancement\\Telekinesis|Energy Emission\\Kinetic Bolt",
        description:
            "The hero can control the energy of motion itself. He can increase or decrease kinetic energy's Intensity by his Power rank number.  He can impart momentum as if he physically pushed the target.  The primary purpose of Kinetic Control is to control Telekinesis and Kinetic Bolts. ",
    },
    {
        category: "Energy Control",
        code: "EC14",
        ...
        optionalPowers:
            "Energy Emission\\Light Emission|Self-Alteration\\Energy Sheath|Travel\\Carrier Wave|Illusionary\\Illusion Casting",
        description:
            "The hero can manipulate existing light. This can be visible, infrared, or ultraviolet light. The hero can alter the intensity, frequency (color, in other words), and coherence of light. The hero can actually change the direction of light and form crude holograms.",
    },
    {
        category: "Energy Control",
        code: "EC15",
        ...
        description:
            "The hero can control magnetic force. He can increase or decrease magnetism's Intensity by his Power rank number. He can use existing magnetism, whether natural or Power-based, to perform any desired task.  He can shape the field into forms to produce any effect.",
    },
    {
        category: "Energy Control",
        code: "EC16",
        ...
        optionalPowers:
            "Energy Emission\\Plasma Generation|Energy Emission\\Energy Doppelganger|Self-Alteration\\Energy Sheath|Self-Alteration\\Energy Body",
        description:
            "The hero can control fields of highly-charged particles. The hero can increase or decrease the plasma's Intensity and reduce its damage by his Power rank number. The Power has two main uses. The first is shaping plasma fields into any shape desired.  The second use of Plasma Control enables the hero to counteract plasma related Powers.",
    },
    {
        category: "Energy Control",
        code: "EC17",
        ...
        optionalPowers:
            "Energy Emission\\Energy Doppelganger|Self-Alteration\\Energy Sheath|Travel\\Carrier Wave",
        description:
            "The hero can control existing radiowaves, whether AM, FM, or microwaves. The hero can increase or decrease the radiowaves' Intensity by his Power rank number. The Power really comes into its own when used as a form of electronic age Illusion-Casting. That is, the hero creates complex signals that simulate an actual broadcast.",
    },
    {
        category: "Energy Control",
        code: "EC18",
        ...
        optionalPowers:
            "Energy Control\\Light Control|Self-Alteration\\Energy Sheath|Self-Alteration\\Energy Body",
        description:
            "This Power enables the hero to affect normal shadows and, indirectly, light as well. The hero can shift the location and size of normal shadows. He can form them into two-dimensional images that can do Power rank damage to real targets. The hero can also Remote Sense through these shadow-constructs. ",
    },
    {
        category: "Energy Control",
        code: "EC19",
        ...
        optionalPowers:
            "Energy Emission\\Vibration|Energy Control\\Vibration Control",
        description:
            "The hero can control existing sound. This also provides the hero with Resistance to sound-based Powers.",
    },
    {
        category: "Energy Control",
        code: "EC20",
    ...
    },
    {
        ...
        optionalPowers:
            "Energy Emission\\Vibration|Energy Emission\\Sonic Generation|Energy Control\\Sound Manipulation",
        description:
            "The hero can control existing vibrations. These may be natural or Power-based. The hero can increase or decrease the Intensity of the vibration by his Power rank number.",
    },
    ...
    // Energy Emission (EE)
    {
        ...
        optionalPowers:
            "Energy Control\\Coldshaping|Energy Control\\Energy Solidification|Matter Control\\Molding",
        description:
    ...
    },
    {
        ...
        rollExtraInformation: "EMMISSION_POINT_TABLE",
        description:
            "The hero can create electrical streams that can do Power rank damage. The hero can project the electricity through any conductive medium, such as air, water, or metal, at Power rank range. ",
    },
    {
        category: "Energy Emission",
        code: "EE3",
    ...
    },
    {
        ...
        rollExtraInformation: "EMMISSION_POINT_TABLE",
        description:
            'This covers the dangerous section of the energy spectrum: ultraviolet light, x-rays, and alpha and beta particles, gamma rays, and the ever-popular "cosmic rays". The hero can project any of these types at Power rank range and damage. ',
    },

    {
        ...
        rollExtraInformation: "EMMISSION_POINT_TABLE",
        description:
            "The hero can generate pure heat that is not necessarily accompanied by light or flame by accelerating molecular motion. This permits the hero to do rank level effects over target materials. Because this Power uses pure heat, it can function in conditions that negate Flame Emission, like the absence of free oxygen or the hero's being underwater.",
    },
    {
        category: "Energy Emission",
        code: "EE7",
        ...
        rollExtraInformation: "EMMISSION_POINT_TABLE",
        optionalPowers:
            "Energy Control\\Kinetic Control|Mental Enhancement\\Telekinesis",
        description:
    ...
    },
    {
        ...
        rollExtraInformation: "EMMISSION_POINT_TABLE",
        description:
            "The hero can generate intense magnetic force. The magnetic field may be centered on the hero's body or be projected at rank range. The field can affect anything susceptible to magnetism, attracting it with Power rank Strength. The hero can induce magnetism into any materials that can sustain a magnetic field.",
    },
    {
        category: "Energy Emission",
        code: "EE10",
    ...
    },
    {
        ...
        rollExtraInformation: "EMMISSION_POINT_TABLE",
        optionalPowers:
            "Energy Control\\Radiowave Control|Self-Alteration\\Energy Sheath|Travel\\Carrier Wave",
        description:
            "The hero can generate radiowaves, including AM and FM signals and microwaves. This Power primarily affects broadcasting and electronics; the Power can do rank damage over rank range to these. The Power can also be used to directly affect any target by internally heating it through microwave bombardment.",
    },
    {
        category: "Energy Emission",
        code: "EE12",
        ...
        rollExtraInformation: "EMMISSION_POINT_TABLE",
        optionalPowers:
            "Energy Control\\Shadowshaping|Energy Control\\Darkforce Manipulation",
        description:
    ...
    },
    {
        ...
        rollExtraInformation: "EMMISSION_POINT_TABLE",
        optionalPowers:
            "Energy Control\\Sound Manipulation|Energy Emission\\Vibration|Energy Control\\Vibration Control",
        description:
            "The hero can generate intense sound and make attacks of Power rank range and damage. This Power can generate frequencies normally inaudible. The hero can disrupt other sound-based Powers by creating dissonance as his harmonics clash with the second Power's harmonics.",
    },
    {
        category: "Energy Emission",
        code: "EE14",
        ...
        rollExtraInformation: "EMMISSION_POINT_TABLE",
        optionalPowers:
            "Energy Control\\Vibration Control|Energy Emission\\Sonic Generation",
        description:
            "The hero can generate non-audible vibrations. These can alter existing harmonics, effectively negating any sonic- or vocal-based Power. The hero can cause tremors at Power rank range and damage. The Power can even be used to incapacitate living targets; effects can vary from motion sickness (nausea and vomiting) to death by internal hemmorhaging. ",
    },
    ...
    },
    {
        ...
        optionalPowers:
            "Mental Enhancement\\Iron Will|Fighting\\Weapons Creation",
        description:
            "This Power increases the hero's already-mastered Martial Arts to dramatically higher levels and allows him to perform actions that would otherwise be impossible.",
    },
    {
        category: "Fighting",
        code: "F3",
        ...
        description:
            "The hero's body contains special anatomical features that can function as weapons. These may be of any nature and can be external, internal, or retractable. If these are damaged the hero suffers as if they were normal body parts. When creating the hero, the player decides the nature of the weaponry.",
    },
    {
        category: "Fighting",
        code: "F4",
    ...
    },
    {
        ...
        description:
            "The hero can devise and assemble any weapon that can be made with the available materials. Provided he has the resources, the hero can assemble a functional copy of any weapon.",
    },

    // Illusory (I)
    {
        category: "Illusionary",
        code: "I1",
        maxRoll: 15,
        name: "Animate Image",
        optionalPowers:
            "Detection\\Telescopic Vision~Mental Enhancement\\Clairvoyance|Energy Control\\Energy Solidification|Matter Creation\\Elemental Creation~Matter Creation\\Molecular Creation",
        description:
    ...
    },
    {
        ...
        optionalPowers:
            "Energy Control\\Energy Solidification|Detection\\Telescopic Vision|Mental Enhancement\\Clairvoyance",
        description:
    ...
    },
    {
        ...
        description:
            "The hero can alter a target's emotional state and resulting activity by forcing him to feel a particular emotion. The hero can only instill one emotion at a time. However, he can select any emotion he desires. The Power affects everyone within its range. ",
    },
    {
        category: "Lifeform Control",
        code: "L5",
        ...
        name: "Exorcism",
        description:
            "The hero can release a being from any external domination imposed by a third party. Such controls include Possession, Mental Domination, Serial Immortality, and Magic. If there's a control, this Power can break it. ",
    },
    {
        category: "Lifeform Control",
        code: "L6",
    ...
    },
    {
        ...
        name: "Mind Control",
        description:
            "The hero has the ability to directly control a target's mind through psionic Powers. The hero completely overrides the will and perhaps even the conscious mind of the target. ",
    },
    {
        category: "Lifeform Control",
        code: "L11",
    ...
    },
    {
        ...
        description:
            "The hero can alter a target's neural activity. By changing nerve messages within the target's body, the hero can cause a variety of effects: Disruption, Paralysis, Seizure, and Exaggeration.",
    },
    {
        category: "Lifeform Control",
        code: "L13",
    ...
    },
    {
        ...
        name: "Plant Control",
        description:
            "The hero can impart limited movement and self-awareness to normally unintelligent plants. The plants obey simple commands, and possess rudimentary communication and senses. The hero can accelerate the plants' growth somewhat, but cannot make it exceed normal limits on size or shape.",
    },
    {
        category: "Lifeform Control",
        code: "L15",
    ...
    },
    {
        ...
        description:
            "The hero can deliberately change the manner in which a target either receives sensory stimuli or processes it within the brain. The simplest form negates one or more of the senses, producing instant blindness, deafness, numbness, and so on. More complex is the ability to modify the senses.",
    },
    {
        category: "Lifeform Control",
        code: "L17",
    ...
    },
    {
        ...
        name: "Sleep-Induced",
        description:
            "The hero has the ability to put any target into a deep sleep, from which he cannot awake while the Power is in effect. During this induced sleep, the target is completely helpless. ",
    },
    {
        category: "Lifeform Control",
        code: "L19",
    ...
    },
    {
        ...
        name: "Undead Control",
        description:
            'he hero can dominate the wills and actions of previously living, still-corporeal beings. Such beings are often called "zombies" or "zuvembies" and are only semi-intelligent. Once control is established, the hero can order the undead to perform any task he desires, so long as it is within their ability. Control ceases when the task is accomplished, but can be reinstated at that time. This Power cannot affect anything alive. ',
    },
    ...
    },
    {
        ...
        optionalPowersMax: 1,
        optionalPowers:
            "Energy Emission\\Energy Doppelganger|Illusionary\\Illusory Duplication|Matter Creation\\Lifeform Creation|Mental Enhancement\\Free Spirit|Self-Alteration\\Anatomical Separation|Self-Alteration\\Self-Duplication|Travel\\Astral Body",
        description:
    ...
    },
    {
        ...
        rollExtraInformation: "MAGIC_MECHANISM_TABLE",
        optionalPowers:
            "Mental Enhancement\\Hyper-Intelligence|Mental Enhancement\\Total Memory",
        description:
            "The Mage has the ability to create new Magical Powers and invest them into sentient beings for their own use. The new Magic can be of any nature, including any of the listings in this book, so long as they are treated as Magical rather than normal Powers. The Magical Powers she confers are nowhere near as high ranked as those the Mage possesses.",
    },
    {
        category: "Magic",
        code: "MG6",
        ...
        rollExtraInformation: "MAGIC_MECHANISM_TABLE",
        optionalPowers:
            "Lifeform Control\\Mind Control|Power Control\\Domination",
        description:
    ...
    },
    {
        ...
        rollExtraInformation: "MAGIC_MECHANISM_TABLE",
        optionalPowers:
            "Lifeform Control\\Mind Transferral|Power Control\\Power Transferral",
        description:
            "The Mage can transfer some or all of her Magic to another sentient being. Only this Power cannot be transferred. Any combination of Powers and ranks can be transferred. The rank of each spell decreases the rank for that spell still held by the Mage.",
    },
    {
        category: "Magic",
        code: "MG8",
    ...
    },
    {
        ...
        rollExtraInformation: "MAGIC_MECHANISM_TABLE",
        description:
            "This is not an actual Magical Power. What it is is a Magical version of any Power in the Ultimate Powers Book. Once this Magical Power appears and the player rolls again to gain an actual Power, any other Powers the player gains should also be considered to be Magical in nature.",
    },
    {
        category: "Magic",
        code: "MG10",
        ...
        rollExtraInformation: [
            "MAGIC_MECHANISM_TABLE",
            "MAGIC_REALITY_ALTERATION_TABLE",
        ],
        optionalPowers:
            "Mental Enhancement\\Precognition|Mental Enhancement\\Clairvoyance|Mental Enhancement\\Postcognition",
        description:
            "The Mage can reshape time itself in order to achieve a desired situation.",
    },
    {
        category: "Magic",
        code: "MG11",
    ...
    },
    {
        ...
        name: "Collection",
        optionalPowers:
            "Matter Control\\Crystallization|Matter Control\\Matter Animation|Matter Control\\Micro-Environment|Matter Control\\Molding|Matter Control\\Weather|Matter Conversion\\Elemental Conversion|Matter Conversion\\Molecular Conversion",
        description:
            "The hero can cause any desired material to collect in a specific location. This material must already be present and diffused throughout the hero's vicinity, whether in the air, water, soil, or scattered across the ground.",
    },
    {
        category: "Matter Control",
        code: "MC3",
        ...
        optionalPowers:
            "Fighting\\Weapons Creation|Matter Control\\Collection|Matter Control\\Matter Animation|Matter Creation\\Missile Creation|Matter Creation\\Spray",
        description:
    ...
    },
    {
        ...
        description:
            "The hero can reduce the size of a target. The target must be in line of sight and within one area of the hero. Any material can be Diminished by this Power with the sole exception of material that has already been Diminished by an equal or higher rank of this Power. ",
    },
    {
        category: "Matter Control",
        code: "MC5",
        ...
        name: "Disruption",
        description:
            "The hero can destroy a target's physical structure without resorting to a physical or overt energy attack. The molecular bonds that give a target its solidity are directly Disrupted, with the result that the target collapses into dust, sand, liquid, or even vapor. ",
    },
    {
        category: "Matter Control",
        code: "MC6",
    ...
    },
    {
        ...
        name: "Geoforce",
        description:
            "The hero can detect and control geological forces. These include plate movement, stress, faults, and vulcanism. This Power only applies to natural rock and semi-natural materials such as concrete, cement, and asphalt. Radically altered material (steel, plastic) is not directly affected by the Power. ",
    },
    {
        category: "Matter Control",
        code: "MC8",
        ...
        description:
            "The hero can alter the flow of any raw matter, impart movement to stationary matter, and shape such matter into any desired form. The Power can only affect matter that is in a relatively natural state. ",
    },
    {
        category: "Matter Control",
        code: "MC9",
        ...
        optionalPowers:
            "Mental Enhancement\\Communicate with Cybernetics|Mental Enhancement\\Communicate with Non-Living|Matter Control\\Matter Animation",
        description:
    ...
    },
    {
        ...
        name: "Molding",
        optionalPowers:
            "Matter Conversion\\Elemental Conversion|Matter Conversion\\Molecular Conversion|Matter Control\\Collection|Matter Control\\Crystallization",
        description:
    ...
    },
    {
        ...
        name: "Weather",
        optionalPowers:
            "Detection\\Environmental Awareness|Travel\\True Flight~Travel\\Whirlwind~Travel\\Gliding",
        description:
            "The hero has complete control over the weather. He can sense those factors in the air that create weather and alter any aspect of them at his desire. Any of these factors can produce both physical and psychological effects on humans. He can control temperature.",
    },
    {
        category: "Matter Control",
        code: "MC13",
        ...
        optionalPowers:
            "Detection\\Extradimensional|Lifeform Control\\Forced Reincarnation|Lifeform Control\\Summoning|Lifeform Control\\Undead Control|Mental Enhancement\\Communicate with Non-Living",
        description:
    ...
    },
    {
        ...
        name: "Combustion",
        optionalPowers:
            "Energy Emission\\Fire Generation|Energy Control\\Fire Control",
        description:
            "The hero has the ability to transform any target into combustible material. Once this Power has been used, spontaneous combustion occurs. Only the surface layer of matter is converted by this Power.",
    },
    {
        category: "Matter Conversion",
        code: "MCo3",
    ...
    },
    {
        ...
        optionalPowers:
            "Matter Control\\Matter Animation|Matter Control\\Molding",
        description:
            "The hero can convert any matter into a specific element. The matter to be converted can be any one element or a combination of elements. The resulting element can be any of the hundred-odd natural, artificial, and mythical elements.",
    },
    {
        category: "Matter Conversion",
        code: "MCo5",
        ...
        name: "Ionization",
        description:
            "The hero has the ability to change the state of energy in a target.",
    },
    {
        category: "Matter Conversion",
        code: "MCo6",
        ...
        optionalPowers:
            "Matter Control\\Matter Animation|Matter Control\\Molding",
        description:
            "The hero can transform any material into a desired compound. This Power is an enhanced version of Elemental Conversion. Whereas that Power could only create a single specified element, this Power can create a number of elements simultaneously and arrange them in a desired molecular configuration.",
    },
    ...
    // Matter Creation (MCr)
    {
        ...
        optionalPowers:
            "Matter Control\\Matter Animation|Mental Enhancement\\Hyper-Intelligence",
        description:
            "The hero can create a desired object from virtually nothing. The artifact can be of any substance, and is limited to being composed of a single piece. Although the Power can create facsimilies of more complex construction, close examination reveals that all the smaller pieces are fused together. However, the hero can create complex items by forming them one piece at a time. The hero must have detailed knowledge of the design of whatever he wants to create. He can only store a finite number of designs in his mind at any one time. The hero can materialize the artifact at any site within one area. The artifact is initially stationary. The hero can create facsimilies of living matter, but such facsimilies are not themselves capable of living.",
    },
    {
        category: "Matter Creation",
        code: "MCr2",
        ...
        optionalPowers:
            "Matter Control\\Matter Animation|Matter Control\\Machine Animation",
        description:
            "The hero can create pure elements from virtually nothing. The hero can create any desired element in any shape or at any location within one area.",
    },
    {
        category: "Matter Creation",
        code: "MCr3",
        ...
        optionalPowers:
            "Mental Enhancement\\Telepathy|Lifeform Control\\Mind Control|Lifeform Control\\Plant Control",
        description:
    ...
    },
    {
        ...
        optionalPowers:
            "Matter Control\\Machine Animation|Mental Enhancement\\Hyper-Intelligence|Mental Enhancement\\Hyper-Invention",
        description:
            "The hero can create complex mechanical devices from virtually nothing. The newly created machine originally forms in one mass, then separates into its components. Heavier machines have to be assembled in several turns. The hero can materialize the machine at any site within one area. The machine is initially stationary but if it is self powered, it can immediately begin to move on its own.  The Power cannot create actual living beings.",
    },
    {
        category: "Matter Creation",
        code: "MCr5",
    ...
    },
    {
        ...
        optionalPowers:
            "Matter Control\\Matter Animation|Matter Control\\Machine Animation",
        description:
            "This is a more powerful form of Elemental Creation. The hero can form several elements simultaneously and form them into any desired compound. The hero can form this on any target within one area. Each ounce the hero creates temporarily costs him one point of Health.",
    },
    {
        category: "Matter Creation",
        code: "MCr7",
        ...
        name: "Spray",
        description:
            "The hero can spontaneously create a directed cloud of gas, mist, or dust. The Spray has a range of up to one area. The main purpose of Spray is combining it with other Powers, thereby producing unique Spray Powers for the hero.  If a character is High Tech, has rolled such Powers as Hyper-Invention or Weapons Tinkering, or possesses a magical device, then the Spray Power should be incorporated into a device. ",
    },
    {
        category: "Matter Creation",
        code: "MCr8",
    ...
    // Mental Enhancement (M)
    {
        ...
        name: "Clairaudience",
        optionalPowers:
            "Detection\\Hyper-Hearing|Mental Enhancement\\Clairvoyance|Mental Enhancement\\Remote Sensing",
        description:
    ...
    },
    {
        ...
        name: "Clairvoyance",
        optionalPowers:
            "Mental Enhancement\\Clairaudience|Mental Enhancement\\Remote Sensing",
        description:
    ...
    },
    {
        ...
        optionalPowers:
            "Mental Enhancement\\Linguistics|Mental Enhancement\\Communicate with Cybernetics~Mental Enhancement\\Communicate with Non-Living~Mental Enhancement\\Communicate with Plants",
        description:
            "The hero can understand and use the languages employed by animals and other non-sentient lifeforms. The Power can be used to communicate with non-sentient alien creatures but not intelligent aliens.",
    },
    {
        category: "Mental Enhancement",
        code: "M4",
        ...
        description:
            "The hero can directly communicate with complex machines, whether these are computers or machines not normally considered to have artificial intelligence. Any machine that possesses any kind of programming can be communicated with-calculators, digital watches, microwave ovens, even music boxes.",
    },
    {
        category: "Mental Enhancement",
        code: "M5",
        ...
        description:
            "This is a catch-all name for anything not covered by the other Communication Powers (M3, M4, M6). It will enable the hero to communicate with anything that had once been either sentient, cybernetic, or alive, as long as the target lacks those qualities now.",
    },
    {
        category: "Mental Enhancement",
        code: "M6",
        ...
        optionalPowers:
            "Mental Enhancement\\Communicate with Animals|Mental Enhancement\\Communicate with Non-Living|Lifeform Control\\Plant Control|Lifeform Control\\Plant Growth",
        description:
            "The hero can speak with plants. Anything that has a vegetable physiology can be affected by this Power, such as grass, and trees.",
    },
    {
        category: "Mental Enhancement",
        code: "M7",
        ...
        description:
            "The hero is in tune with the entire scope of reality. He possesses a detached, omniscient viewpoint that allows him to explore the entire existence of a chosen subject. Unfortunately, this causes such a massive overload of superfluous information that the hero is hard pressed to sort it all out.",
    },
    {
        category: "Mental Enhancement",
        code: "M8",
        ...
        name: "Danger Sense",
        description:
            "This is also called Combat Sense. It is a combination of automatically functioning Psionic Powers (Telepathy, Empathy, and Precognition) that warns the hero about impending danger.",
    },
    {
        category: "Mental Enhancement",
        code: "M9",
    ...
    },
    {
        ...
        name: "Empathy",
        optionalPowers:
            "Mental Enhancement\\Clairvoyance|Lifeform Control\\Emotion Control",
        description:
            "The hero can detect the surface emotions of others. The hero can detect the target's emotional state and further refine that knowledge to discover the target's physical state, surroundings, and location, in-so-far as these have an influence on the emotions. He can transmit his own emotional state but he cannot impose this on others.",
    },
    {
        category: "Mental Enhancement",
        code: "M11",
    ...
    },
    {
        ...
        optionalPowers:
            "Mental Enhancement\\Hyper-Invention|Mental Enhancement\\Total Memory",
        description:
            "Normally a character's Intelligence is determined in the Charactor Generation Process. The hyper-intelligent character is a genius of awesome potential. He can quickly master new subjects, retain that knowledge indefinitely, and easily succeed in any mental endeavor.",
    },
    {
        category: "Mental Enhancement",
        code: "M14",
        ...
        optionalPowers:
            "Fighting\\Weapons Tinkering|Matter Control\\Machine Animation|Matter Control\\Molding|Matter Creation\\Artifact Creation|Matter Creation\\Mechanical Creation",
        description:
            "This is a special form of Hyper-intelligence that is common enough to merit its own classification. It is a permanent enhancement of the hero's overall intelligence that is channeled into the field of mechanical design and engineering. The hero is an Edison-like genius who take existing materials and technologies and use them to create new devices or applied technologies. He can repair previously operational devices, even if the device was of anunknown type. The hero can learn new technologies at a rate determined by his rank, the complexity of the technology, and the amount of instruction available.",
    },
    {
        category: "Mental Enhancement",
        code: "M15",
    ...
    },
    {
        ...
        name: "Iron Will",
        description:
            "The hero has complete conscious control over his mind and body. By using his Iron Will, the hero can temporarily halt the damage done by mental or physical attacks; he can even postpone his own death. Iron Will can be used in place of any lower-ranked Ability to determine Resistance to an attack.",
    },
    {
        category: "Mental Enhancement",
        code: "M17",
    ...
    },
    {
        ...
        optionalPowers:
            "Mental Enhancement\\Mind Drain|Power Control\\Duplication",
        description:
            "This is a combination of Powers that enables the hero to psionically study a subject's mind and then create a simulation of that mind within the hero's own brain. This is a great way to learn secrets and interrogate subjects who would otherwise be rather uncooperative. The duplicated mind contains the personality of the original, most memories, and possibly the mental or psionic Powers of the original. The subject is unaffected by the Power and loses none of his own mental abilities.",
    },
    {
        category: "Mental Enhancement",
        code: "M19",
        ...
        description:
            "The hero has the ability to render his own mental energies undetectable by external means. Such means can be technological (EEG scans), psionic, Magical, or Power-based in nature. It is Invisibility in telepathic terms. The Power protects the hero from discovery by outside forces.",
    },
    {
        category: "Mental Enhancement",
        code: "M20",
        ...
        name: "Mental Probe",
        optionalPowers:
            "Mental Enhancement\\Telepathy|Mental Enhancement\\Sensory Link",
        description:
            "The hero can telepathically probe a living mind or a psionic phenomenon to gain a detailed analysis of the target. Living minds can be searched for specific images and thoughts, although the hero must have a basic idea beforehand of what she is looking for.",
    },
    {
        category: "Mental Enhancement",
        code: "M21",
        ...
        name: "Mind Blast",
        optionalPowers:
            "Mental Enhancement\\Telepathy|Mental Enhancement\\Mental Probe",
        description:
            "The hero can create bolts of pure psionic energy that can be used to directly damage a target's neural system.",
    },
    {
        category: "Mental Enhancement",
        code: "M22",
        ...
        name: "Mind Drain",
        optionalPowers:
            "Mental Enhancement\\Telepathy|Mental Enhancement\\Mental Probe|Mental Enhancement\\Mental Duplication|Mental Enhancement\\Mind Blast",
        description:
            "The hero can deplete, negate, or even destroy a target's mental faculties. This alters the target's personality, memory, thought process (Reason and Intuition), and any Mental or Psionic Powers the target had.",
    },
    {
        category: "Mental Enhancement",
        code: "M23",
    ...
    },
    {
        ...
        name: "Remote Sensing",
        optionalPowers:
            "Mental Enhancement\\Clairaudience|Mental Enhancement\\Clairvoyance",
        description:
            "This is a catch-all name for any Power that enables the hero to psionically extend the range of any sense. The senses include taste, smell, touch, balance (including gravity sensing), and temperature. The exceptions are sight and hearing.",
    },
    {
        category: "Mental Enhancement",
        code: "M27",
        ...
        optionalPowers: "Mental Enhancement\\Telepathy",
        description:
            "The hero can telepathically link his senses with those of another being. He can use the information gained from the other's senses as if it came from the hero's own senses.  The Power is crucial to sense-impaired characters.",
    },
    {
        category: "Mental Enhancement",
        code: "M28",
        ...
        description:
            "A character with this Power can suffer damage, get sick, age, and even die. None of it is permanent to the character, though. When the hero's body dies from any cause, the unique nature of his lifeforce enables it to transfer to a new body. He can also transfer some but not all of his Powers to the new body.",
    },
    {
        category: "Mental Enhancement",
        code: "M29",
        ...
        optionalPowers:
            "Mental Enhancement\\Clairvoyance|Physical Enhancement\\Vocal Control|Detection\\Hyper-Hearing|Mental Enhancement\\Sensory Link",
        description:
    ...
    },
    {
        ...
        name: "Telekinesis",
        optionalPowers:
            "Matter Control\\Matter Animation|Matter Control\\Molding|Mental Enhancement\\Clairvoyance|Mental Enhancement\\Remote Sensing|Travel\\Levitation|Travel\\True Flight",
        description:
            "The hero can handle material objects without having to make direct or indirect physical contact. The hero can perform any action that could be accomplished using normal Strength.",
    },
    {
        category: "Mental Enhancement",
        code: "M31",
        ...
        name: "Telelocation",
        optionalPowers:
            "Mental Enhancement\\Clairvoyance|Detection\\Extradimensional",
        description:
            'The hero can Psionically locate a chosen target. This differs from normal Tracking in that no physical or sensory contact, however tenuous, is required. Consequently, the Power is not hampered by the concealment, erasure, or absence of the target\'s "scent." Telelocation can operate over immense distances.',
    },
    {
        category: "Mental Enhancement",
        code: "M32",
        ...
        name: "Telepathy",
        optionalPowers:
            "Mental Enhancement\\Empathy|Mental Enhancement\\Hallucinations|Mental Enhancement\\Mental Invisibility|Mental Enhancement\\Mental Probe|Mental Enhancement\\Mind Blast|Mental Enhancement\\Mind Drain|Mental Enhancement\\Sensory Link|Detection\\Psionic Detection",
        description:
            "The hero can communicate on a direct mind-to-mind basis. This is automatic with willing minds or Psyches with ranks lower than the Power rank.",
    },
    {
        category: "Mental Enhancement",
        code: "M33",
        ...
        name: "Total Memory",
        optionalPowers:
            "Mental Enhancement\\Hyper-Invention|Mental Enhancement\\Hyper-Intelligence|Fighting\\Weapons Tinkering",
        description:
            "The hero has the ability to remember anything that he has ever experienced. This could be a book he's read, the faces of everyone he saw on Tuesday, what birth was like, and so on.",
    },
    ...
    },
    {
        ...
        name: "Chemical Touch",
        description:
            "The hero's body secretes chemicals that are capable of a variety of effects on a target.  The chemicals can be automatically or consciously secreted. The range is always limited to Contact only.",
    },
    {
        category: "Physical Enhancement",
        code: "P4",
        ...
        optionalPowers:
            "Physical Enhancement\\Lung Adaptability|Self-Alteration\\Body Adaptation",
        description:
            "The hero can swallow and digest any substance without harm. The digestive tract extracts useful materials and synthesizes new ones from the available material.",
    },
    {
        category: "Physical Enhancement",
        code: "P5",
        ...
        name: "Hyper-Speed",
        description:
            "The hero is capable of extremely fast motion and may even surpass lightspeed. Normally this Power includes a specific resistance to friction and lungs that are adapted to breathe high-velocity air.",
    },
    {
        category: "Physical Enhancement",
        code: "P6",
    ...
    },
    {
        ...
        description:
            "The hero can breathe any gaseous or liquid medium without harm. The lungs can extract required gases (oxygen for humans) or even create them by converting available elements. ",
    },
    {
        category: "Physical Enhancement",
        code: "P8",
    ...
    },
    {
        ...
        name: "Regeneration",
        description:
            "The hero can rapidly recover from any wound. Cuts quickly close and disease symptoms disappear. The hero heals at an accelerated rate equal to the Power rank number times the normal amount of time.",
    },
    {
        category: "Physical Enhancement",
        code: "P10",
        ...
        name: "Self-Revival",
        description:
            "The hero's Power is so strong that it can repair fatal damage and actually return the hero to life. The power functions despite the absence of life in the body. It repairs the major damage and replaces lost tissues at the same rate as Regeneration. When the body is returned to minimum life sustaining condition, the hero comes back to life. ",
    },
    {
        category: "Physical Enhancement",
        code: "P11",
        ...
        description:
            "The hero can survive indefinitely without consuming air, water, or food. Bodily wastes are internally recycled back into useable materials. Normally the hero would not need to replenish himself when his power reached its limit.",
    },
    {
        category: "Physical Enhancement",
        code: "P12",
    ...
    },
    {
        ...
        description:
            "This is a combination of Resistances and Body Armor. The hero is immune to any physical harm, up to his rank's limit. The immunity includes the following resistances: fire, heat, cold, electricity, radiation, corrosives, disease, poison, brute force, sonics, and kinetic bolts.",
    },
    {
        category: "Physical Enhancement",
        code: "P15",
        ...
        name: "Vocal Control",
        description:
            "This might be considered a Talent rather than a Power, but here goes anyway. The hero has total control over his own voice and can use it to duplicate any desired voice of sound. The accuracy of the simulated sound is 100% within the Power's limit.",
    },
    {
        category: "Physical Enhancement",
        code: "P16",
        ...
        name: "Waterbreathing",
        description:
            'This may be a "wimp Power," but it would be embarrassing for an extremely powerful character to drown while a relatively wimpish water breather went unharmed. This power may be permanent or temporary.',
    },
    {
        category: "Physical Enhancement",
        code: "P17",
        ...
        description:
            "The hero's body is adapted for movement in the water. The hero can move through water with the same ease that normal beings can move through air. Note: This power does not automatically include Water-Breathing.",
    },
    ...
    // Power Control (PC)
    {
        ...
        description:
            "The hero can alter the behavior of pure Power, whether it is in a raw or applied state. The hero can control the actions of any Powers within his range and capability. ",
    },
    {
        category: "Power Control",
        code: "PC2",
        ...
        name: "Creation",
        description:
            "The hero has the ability to create new Powers and invest them into sentient beings for their own use. The new Powers can be of any nature and can be any of the listings.  The hero is limited in the number and ranks of the Powers he can create.",
    },
    {
        category: "Power Control",
        code: "PC3",
        ...
        name: "Domination",
        optionalPowers:
            "Lifeform Control\\Mind Control|Magic\\Magic Domination",
        description:
    ...
    },
    {
        ...
        optionalPowers:
            "Lifeform Control\\Mind Transferral|Magic\\Magic Transferral",
        description:
            "The hero can transfer some or all of his Powers to another sentient being. The transferral can be any combination of Powers and ranks. Only this Power cannot be transferred. Each transferred Power rank diminishes the hero's own rank for that Power. The optimum range for Power Transferral is contact.",
    },
    {
        category: "Power Control",
        code: "PC11",
    ...
    },
    {
        ...
        description:
            "The hero can duplicate a Power by absorbing the traces left behind whenever a Power is used. The residue may be in anything that was near the target of a Power's emission. ",
    },
    {
        category: "Power Control",
        code: "PC13",
        ...
        name: "Selection",
        description:
            "The hero can possess any number of Powers but can only use a single one at a given time. Switching between Powers takes three turns. When the player generates this Power, he gets to generate an additional Power as well.",
    },
    {
        category: "Power Control",
        code: "PC14",
    ...
    // Self-Alteration (S)
    {
        ...
        name: "Age-Shift",
        description:
            "The hero can alter his apparent age at will.  His body and physiology change to simulate any age, younger or older. Mental facilities remain unaffected. ",
    },
    {
        category: "Self-Alteration",
        code: "S2",
    ...
    },
    {
        ...
        description:
            "The hero can alter his appearance, form, and dimensions to appear as any desired animal form. This Power can also be used to assume alien appearances. The only limitation is that the hero's basic physiology remains unchanged.",
    },
    {
        category: "Self-Alteration",
        code: "S5",
        ...
        name: "Animal Mimicry",
        description:
            "This is a form of Power Duplication. The hero can duplicate the natural abilities of any animal. The hero's body does not significantly change; instead, existing flesh changes the way it functions.",
    },
    {
        category: "Self-Alteration",
        code: "S6",
        ...
        name: "Blending",
        description:
            "The hero has the ability to match his color exactly to his surroundings. This Power functions as a practical invisibility. The body's outline and contours are still detectable if the observer is very careful. The Power is most effective if the hero is in low light or at a distance from the viewer. ",
    },
    {
        category: "Self-Alteration",
        code: "S7",
    ...
    },
    {
        ...
        description:
            "The hero can alter the nature of elements and compounds within his own body. Innate safeguards in this Power maintain the hero's lifeforce in any altered state. Altered states may not necessarily be mobile, or may move in new ways.",
    },
    {
        category: "Self-Alteration",
        code: "S9",
        ...
        name: "Body Coating",
        description:
            "The hero can surround himself witha flexible layer of a protective substance not normally found on his body. The body coat provides protection and allows the hero's Powers to manifest. Any damage to the coating can be quickly repaired by the hero's body secreting more of the coating material. The degree of protection and the speed of repair to the coating are determined by the Power rank.",
    },
    {
        category: "Self-Alteration",
        code: "S10",
        ...
        description:
            "This is related to both S7/Body Transformation-Self and to Power Duplication. The hero can duplicate the chemical properties of any element or compound without his own body actually changing in composition. The hero's flesh simply acts as if it were the desired substance. ",
    },
    {
        category: "Self-Alteration",
        code: "S11",
        ...
        name: "Energy Body",
        description:
            "The hero can transform his body into a coherent energy field that supports his lifeforce and is capable of controlled actions. The energy can be of any type.",
    },
    {
        category: "Self-Alteration",
        code: "S12",
        ...
        name: "Energy Sheath",
        description:
            "The hero can surround himself with an energy field. This field provides protection, lifesupport, and a means of manifesting the hero's other Powers. The energy field can be of any type.",
    },
    {
        category: "Self-Alteration",
        code: "S13",
        ...
        name: "Evolution",
        description:
            "The hero can alter his mind and body to simulate any stage of the evolutionary path of his species.",
    },
    {
        category: "Self-Alteration",
        code: "S14",
        ...
        name: "Imitation",
        description:
            "The hero can change his superficial appearance but cannot alter his basic form or dimensions. The hero has conscious control over the movement and placement of muscles, cartilage, and minor bones and can alter the color and appearance of his skin and hair.",
    },
    {
        category: "Self-Alteration",
        code: "S15",
        maxRoll: 81,
        name: "Humanoid Changling",
        description:
    ...
    },
    {
        ...
        name: "Plant Mimicry",
        description:
            "This is a form of Power duplication. The hero can duplicate the natural abilities of any plant. The body does not significantly change, aside from the instantaneous appearance of chlorophyll in the hero's skin whenever he uses this Power.",
    },
    {
        category: "Self-Alteration",
        code: "S19",
    ...
    },
    {
        ...
        description:
            "The hero can alter both his shape and physiology to become any desired plant form. The degree of change can vary wildly. At the least, the hero's body changes into a similarly-shaped \"plantman;\" at higher ranks the hero may assume normal or alien plant shapes. When in plant-form, the hero is immune to attacks that specifically affect animal life but is vulnerable to attacks that affect plant life.  When in plant form, the hero doesn't need to eat normal food; rather he uses photosynthesis to gain desired energy.",
    },
    {
        category: "Self-Alteration",
        code: "S22",
        ...
        name: "Shapeshifting",
        description:
            "The hero can drastically alter all of his physical parameters to achieve any desired shape. Despite appearances, the hero retains his basic chemical composition unless other Powers are used simultaneously, such as S8/Body Transformation—Self.",
    },
    {
        category: "Self-Alteration",
        code: "S23",
        ...
        name: "Spirit Gestalt",
        description:
            "The hero can transform into a heroic Alter Ego by joining his mind and body with one or more disembodied beings. The joining of these disparate beings generates the Power possessed by the Gestalt hero.",
    },
    ...
    },
    {
        ...
        description:
            "The hero can manipulate energy currents to support and propel his body, thus attaining a form of Flight. The energy can be any type found in the hero'senvironment, such as magnetism, sound, light, heat, and electricity. The hero can use only one form. The Carrier Wave can support the hero and an additional load. The maximum speed is that of normal energy of the type composing the wave.",
    },
    {
        category: "Travel",
        code: "T3",
        ...
        description:
            "The hero can travel into a number of other Dimensions. Transit to a random dimension normally occurs automatically but the Power is weakened by adrenalin. The return trip is easier. Returning at a random location on the homeworld is automatic.  The hero initially has two dimensions he can travel to, his home and one other realm.",
    },
    {
        category: "Travel",
        code: "T4",
    ...
    },
    {
        ...
        description:
            "The hero can create a glowing platform of solid light. The disc materializes to support any part of the hero's body; generally this is under the feet or posterior. The disc is a part of the hero's Power and has no independent existence beyond him. The disc can automatically support the hero and additional mass.",
    },
    {
        category: "Travel",
        code: "T6",
        ...
        name: "Gateway",
        description:
            "The hero can travel to any point in space, time, or other dimensions by traveling along bridges she creates herself. She can travel along a bridge from her current location to a location in space, time, and other dimensions. The destination of each Gateway is a fixed point in space but the departure end always moves with the hero. The Gateway forms within ten feet of the hero. It can maintain its existence for as long as the hero concentrates on it or until he passes through it.",
    },
    {
        category: "Travel",
        code: "T7",
        ...
        name: "Gliding",
        optionalPowers:
            "Matter Control\\Weather|Matter Control\\Matter Animation",
        description:
            "The hero can travel on air currents. In normal air currents, the hero drops one story for each turn she is in the air.  The glider can climb by using updrafts.  She can carry aloft an additional mass. Gliding can be affected by high winds or the Powers of Weather Control and Air Animation.",
    },
    {
        category: "Travel",
        code: "T8",
        ...
        bonusPowerCount: 1,
        bonusPower:
            "Fighting\\Natural Weaponry(50)|Physical Enhancement\\Body Resistance(100)",
        optionalPowers:
            "Physical Enhancement\\Armor Skin|Physical Enhancement\\Body Resistance",
        description:
            "The hero can travel swiftly through the earth by burrowing a tunnel at Power rank speed (land movement rate). The Power can be used indefinitely as Hyper-digging has the side-effect of increasing the hero's Strength and Endurance.  Burrowing remains the hero's preferred mode of transportation.",
    },
    {
        category: "Travel",
        code: "T9",
        ...
        description:
            "The hero can jump great distances. By repeated leaps, the hero can rapidly cover large distances. Innate safeguards in this Power enable the hero to safely land.",
    },
    {
        category: "Travel",
        code: "T10",
    ...
    },
    {
        ...
        bonusPowerCount: 1,
        bonusPower:
            "Physical Enhancement\\Waterbreathing(50)|Physical Enhancement\\Water Freedom(100)",
        optionalPowersMax: 1,
        optionalPowers:
            "Physical Enhancement\\Waterbreathing|Physical Enhancement\\Water Freedom",
        description:
            "The hero can cover large distances by swimming at Power rank speed. The Power does not free the hero from the need to breathe. The hero can tow other objects in his wake at a decreased speed. This assumes the towed object has a buoyancy equal to the hero's body. The Nemesis is Matter Animation/ Water.",
    },
    {
        category: "Travel",
        code: "T12",
        ...
        description:
            "The hero can freely resist the pull of gravity. She can move vertically at Power rank speed, hover in place, or drift with the wind. Limited horizontal movement is possible by pushing off from other objects. The maximum distances are determined the same way anormal leap is.  A hero with this Power can never fall unlesss he is unconscious or purposely decides to succumb to gravity.",
    },
    {
        category: "Travel",
        code: "T13",
    ...
    },
    {
        ...
        name: "Spiderclimb",
        description:
            "The hero can travel along vertical or inverted surfaces with only minor difficulty. The maximum speed, assuming the hero is using all his limbs to Spiderclimb, is the same as the hero's normal ground movement rate. ",
    },
    {
        category: "Travel",
        code: "T16",
    ...
    },
    {
        ...
        optionalPowers:
            "Travel\\Teleport Self|Mental Enhancement\\Clairvoyance",
        description:
            "The hero can make any target except his own body vanish and instantly reappear at a distant site. The target does not physically cross the intervening distance and is unaffected by most physical barriers. Teleportation always occurs if the passenger is immobile or touching the hero.",
    },
    {
        category: "Travel",
        code: "T18",
        ...
        optionalPowers:
            "Mental Enhancement\\Clairvoyance|Mental Enhancement\\Free Spirit|Mental Enhancement\\Serial Immortality",
        description:
    ...
    },
    {
        ...
        name: "Time Travel",
        optionalPowers:
            "Travel\\Dimension Travel|Mental Enhancement\\Precognition|Mental Enhancement\\Postcognition|Magic\\Reality Alteration",
        description:
    ...
    },
    {
        ...
        name: "True Flight",
        optionalPowers:
            "Physical Enhancement\\Body Resistance|Physical Enhancement\\Armor Skin|Physical Enhancement\\Self-Sustenance|Mental Enhancement\\Telekinesis",
        description:
            "The hero can fly through air and space without an apparent means of propulsion. This is the most desired Power in the history of the world.  True Flight includes as a side effect Power rank resistance to atmospheric friction and lungs adapted to breathe high velocity wind.",
    },
    {
        category: "Travel",
        code: "T22",
    ...
    },
    {
        ...
        optionalPowers:
            "Matter Control\\Weather|Matter Control\\Matter Animation",
        description:
            "The hero can fly by creating a small cyclone that carries him through the air. Maneuverability is determined by the hero's Agility. In addition to the hero's body, the Whirlwind can support additional weight.  Passengers are not battered by the high winds but are safely held aloft by updrafts in the cyclone's interior. High winds can affect the hero. If the wind is powerful enough, the Whirlwind can be dispersed.",
    },
];
...
const INVISIBILITY_FORM_TABLE = [
    {
        ...
        name: "Physics",
        description:
            "The hero's body is totally transparent to the visible light spectrum. He cannot be mechanically detected or recorded.",
    },
    {
        maxRoll: 50,
        name: "Telepathic",
        description:
            "The hero is actually visible but is ignored and immediately forgotten by beings whowould otherwise be capable of detecting his presence. He is also immune to detection by other senses. He can be mechanically detected and recorded.  He can extend this invisibility to anyone in physical contact with him.  ",
    },
    {
        maxRoll: 75,
        name: "Hallucinatory",
        description:
            "The hero is actually visible but is surrounded by a telepathic field that makes others see an empty spot where the hero is. The Hallucination can incorporate the hero's surroundings and affect real-time viewers at a great distance. In other words, the hero can disguise the area around himself and this disguise will fool anyone looking at the area, even if they are miles away. However, this Power doesn't fool film or videotape; these record the scene as it really is. Hallucination also prevents detection by other senses. The hero can be mechanically detected and recorded; as with the Telepathic form, anyone within range of the effect ignores the hero. Robots and cybernetic beings can also detect him.",
    },
    {
        maxRoll: 100,
        name: "Holographic",
...
const BIOPHYSICAL_CONTROL_FORM_TABLE = [
    {
        ...
        name: "Healing",
        description:
            "The hero can cure the damage caused by wounds, trauma, toxins, and disease.  The Power seals the body and returns any still-living tissues to health. It cannot replace lost tissue.",
    },
    {
        maxRoll: 4,
        name: "Regeneration",
        description:
            "The hero has the ability to heal and can recreate large areas of lost tissue, such as severed limbs or destroyed organs.",
    },
    {
        maxRoll: 48,
        name: "Revival",
        description:
            "The hero can actually bring the dead back to life. The Power begins by healing and regenerating any damage to the body, especially the cause of death. Once the body is habitable again, the Power automatically summons the deceased spirit back and reconnects it with the body.",
    },
    {
        maxRoll: 68,
        name: "Damage Transferral",
        description:
            "The hero can heal another by apparently taking that damage from the victim and moving it into the hero. The Power first heals the target. Simultaneously, the hero's body reshapes itself into a duplication of the damage being healed.",
    },
    {
        maxRoll: 76,
        name: "Decay",
        description:
            "The hero can accelerate the cellular collapse of body tissue. The target becomes leprous, dies, and quickly crumbles to dust if the Power is used long enough.",
    },
    {
        maxRoll: 92,
        name: "Disruption",
        description:
            "The Power can upset the smooth functioning of the physiology. The target suffers Power rank losses to his Health as he suffers anything from minor discomfort to fatal trauma.",
    },
    {
        maxRoll: 100,
        name: "Aging",
        description:
            "The Power can accelerate or reverse the aging process. As the victim's age changes, physiology and mental capacities change as well. While the Power can function as a Fountain of Youth, it can also be used to kill through old age or regression to protoplasm.",
    },
];
...
const EMMISSION_POINT_TABLE = [
    ...
    },
    {
        ...
        name: "Hands",
        description:
            "The Power isbemitted from an aurabsurrounding the hero's hand, fist, or palm. Power travels in the plane formed by the fingers, in line with the whole fist, or in a line perpendicular to the open palm.",
    },
    {
        maxRoll: 67,
        name: "Fingers",
        description:
            "The Power is emitted from an aurabsurrounding the hero's fingers (any number, from one to all of them). It travels in a straight line in the direction the finger points. Usually, the index finger directs the Power, if only one finger is used. If the hero has multiple Powers, each Power can be assigned to a different finger.",
    },
    {
        maxRoll: 70,
        name: "Legs",
        description:
            "The Power is emitted downward from an aura surrounding both legs. It is difficult to aim leg-emitted Power, which travels in the line defined by the lower leg. Such Powers are usually limited in range to contact only.",
    },
    {
        maxRoll: 73,
        name: "Feet",
    ...
    },
    {
        ...
        name: "Antennae/horns",
        description:
            "Power is emitted from the antennae on the hero's head. Power travels in a straight line from the last section of the antennae.",
    },
    {
        maxRoll: 86,
        name: "Tail",
        description:
            "Power is emitted from the tip of the hero's tail and follows astraight line in the direction the tail points. ",
    },
    {
        maxRoll: 100,
        name: "Any Location",
...
const MAGIC_MECHANISM_TABLE = [
    {
        ...
        name: "Word",
        description:
            "The hero needs to speak a single, specific word in order to manifest his Power.",
    },
    {
        maxRoll: 20,
        name: "Chant",
        description:
            "The hero needs to recite a series of words to manifest his Power. The Chant can be any length and form.",
    },
    {
        maxRoll: 28,
        name: "Song",
        description:
            "The hero needs to sing or play a specific song, tune, or rhythm to bring about the desired Effect.",
    },
    {
        maxRoll: 40,
        name: "Gesture",
        description:
            "The hero must perform a specific physical action to bring about the desired Effect.",
    },
    {
        maxRoll: 52,
        name: "Alchemy",
        description:
            "The hero can achieve a specific Effect by following a recipe that combines arcane or even commonplace substances in a special procedure. The resulting substance possesses enough Power to attempt the desired Effect.",
    },
    {
        maxRoll: 60,
        name: "Talisman",
        description:
            "The Mage must possess a specific item in order to achieve his desired Effect.",
    },
    {
        maxRoll: 68,
        name: "Familiar",
        description:
            "The Mage possesses (or is possessed by) a special lifeform who serves as an amplifier, conduit, and transmitting device for the Mage's Power. The hero must be in contact with the Familiar to achieve any type of Effect aside from communication.",
    },
    {
        maxRoll: 76,
        name: "Necromancy",
        description:
            "Necromancy-The Mage can achieve an Effect by using the remnants of lifeforce contained in once-living biological materials.",
    },
    {
        maxRoll: 84,
        name: "Summoning",
    ...
    },
    {
        ...
        name: "Ritual",
        description:
            "This is a combination of the following Mechanisms into a compound Mechanism.",
...
const MAGIC_CONTROL_TABLE = [
    {
        maxRoll: 40,
        name: "Manipulation",
        description: "The Mage can alter the flow and application of Magic.",
    },
    {
        maxRoll: 70,
        name: "Magnification/Reduction",
        description:
            "The Mage can either increase or decrease the rank of the affected Magic by his own Power rank number.",
    },
    {
        maxRoll: 100,
        name: "Negation",
        description:
            "This is an extreme form of Reduction. The Mage can completely dispel any Magic within his scope.",
    },
];
...
const MAGIC_REALITY_ALTERATION_TABLE = [
    {
        ...
        name: "Future",
        description:
            "The Mage can control the probability of a certain event coming to pass.",
    },
    {
        maxRoll: 65,
        name: "Present",
        description:
            "The Mage can change the conditions of her present surroundings. It is as if the Mage had somehow altered the past without realizing it.",
    },
    {
        maxRoll: 75,
        name: "Past",
        description:
            "The Mage can actually change past history and thereby really alter the present.",
    },
    {
        maxRoll: 100,
        name: "Temporal Flow",
        description:
            "The Mage can alter the rate at which time passes. He can accelerate or decelerate it to such a point that the affected area is apparently in stasis. The maximum amount that time",
    },
];
...
const DIMINUTION_MECHANISM_TABLE = [
    {
        ...
        description:
            "The hero decreases the distance between the target's atoms and subatomic particles. The target does not lose weight as it shrinks.",
    },
    {
        maxRoll: 40,
        name: "Atomic Reduction",
        description:
            "The hero decreases the number of atoms in the target's body. The lost matter is either disintegrated (if the Diminution is permanent) or temporarily removed from the target's plane of existence and stored on another plane until it is needed to return the target to its original size.",
    },
    {
        maxRoll: 100,
        name: "Atomic Shrinkage",
        description:
            "This is the most common form of Diminution and the only form that permits the target to enter a Microverse. The hero can reduce the size of the atoms and subatomic particles themselves, thus reducing the over-all size in a proportional manner.",
    },
];
...
const ENLARGEMENT_MECHANISM_TABLE = [
    {
        ...
        description:
            "The Power causes the spaces between the atoms and subatomic particles to increase, thus increasing overall size. Mass remains the same despite any increase in size, causing the target's density to drop.",
    },
    {
        maxRoll: 40,
        name: "Atomic Growth",
        description:
            "The Power causes the target to gain additional atoms. These are automatically incorporated into the target to duplicate and augment existing molecular structures.",
    },
    {
        maxRoll: 100,
        name: "Atomic Gain",
        description:
            "The target's atoms and subatomic particles actually increase in size, thus increasing the target's overall size.",
    },
];
...
const MATTER_ANIMATION_FORM_TABLE = [
    {
        ...
        name: "Air Animation",
        description:
            "The hero can directly control the movement of gases and vapors and indirectly control the movement of material suspended in the air, such as smoke, dust, steam, and so on.",
    },
    {
        maxRoll: 50,
        name: "Liquid Animation",
        description:
            "he hero can directly control the movement of liquids and indirectly control material suspended in liquid (mud, cake batter).",
    },
    {
        maxRoll: 100,
        name: "Solid Animation",
        description:
            "The hero can alter the condition of solid matter, so long as it is not biological or mechanical in nature.",
    },
];
...
const MENTAL_DUPLICATION_FORM_TABLE = [
    {
        ...
        name: "Detachment",
        description:
            "The hero's mind is completely separate from the duplicate and retains full control over the body and other Powers. The hero can examine and communicate with the duplicate. The duplicate retains a facsimile of the original's will and may not choose to voluntarily cooperate with the hero.",
    },
    {
        maxRoll: 70,
        name: "Merge",
        description:
            "The duplicate mind blends with the hero's mind to create a composite mentality. The new mind contains aspects of both minds personalities, memories, and Powers.",
    },
    {
        maxRoll: 100,
        name: "Transformation",
        description:
            "The hero's mind is automatically overwhelmed by the new mind. The hero's personality, memories, and mental Powers are temporarily replaced by the new mind.",
    },
];
...
const SERIAL_IMMORTALITY_FORM_TABLE = [
    {
        ...
        name: "Newborn",
        description:
            "The body is that of an infant.  The character can enter the body at any point from conception to birth. He is helpless until birth actually occurs. He can accelerate the body's physical development in order to induce birth and quickly regain physical maturity.",
    },
    {
        maxRoll: 40,
        name: "Premade",
        description:
            " The new body is a previously prepared clone or android body that was prepared specifically for this purpose. Such a body is already physically mature and in possession of the full range of the hero's Powers.",
    },
    {
        maxRoll: 60,
        name: "Re-animation",
        description:
            "The lifeforce enters and revives a recently deceased but unmutilated corpse, preferably of the same species as the original body.",
    },
    {
        maxRoll: 80,
        name: "Spontaneous Creation",
        description:
            "This is the most sociably acceptable form of Serial Immortality. The hero creates existing matter and energy into the flesh of a new body. The newly-created body is identical to the previous one and possesses all Powers except externally derived ones.",
    },
    {
        maxRoll: 100,
        name: "Parasite",
        description:
            "This is the nastiest, least socially acceptable form of Serial Immortality. The character's lifeforce invades a living, physically mature body and overwhelms the original occupant's mind.",
    },
];
...
const ARMOR_SKIN_FORM_TABLE = [
    {
        ...
        name: "Leather",
        description:
            "The epidermis retains its normal shape and flexibility but is harder to the touch.",
    },
    {
        maxRoll: 60,
        name: "Rigid Plates",
        description:
            "he body is covered in interlinked plates like an insect's chitin or an armadillo's shell.",
    },
    {
        maxRoll: 80,
        name: "Visually Inorganic",
        description:
            "The body can be any shape but has the appearance of nonorganic matter.",
    },
    {
        maxRoll: 100,
        name: "Inorganic",
        description: "he body actually is covered in inorganic material.",
    },
];
...
const CONTROL_FORM_TABLE = [
    {
        maxRoll: 40,
        name: "Manipulation",
        description: "The hero can alter the flow and application of Power.",
    },
    {
        maxRoll: 70,
        name: "Magnification/Reduction",
        description:
            "The hero can either increase or decrease the rank of the affected Power by his Macro-Power's rank number.",
    },
    {
        maxRoll: 100,
        name: "Negation",
        description:
            "The hero can completely dispel any Powers within his range.",
    },
];
...
const TALENT_LIST_ULTIMATE_TABLE = [
    {
        ...
        name: "Catastrophism",
        description:
            "The scientific belief system that attempts to pinpoint the end of the world or at least major catastrophes that could signifantly alter man's or the universe's history.",
    },
    {
        category: "Alternative Sciences",
        maxRoll: 50,
        name: "Cryonics",
        description:
            "The practice of freezing a dead diseased person in hopes of bringing him back in the future when the cure is found.",
    },
    {
        category: "Alternative Sciences",
        maxRoll: 75,
        ...
        description:
            "The study of paranormal phenomena from a scientific standpoint.",
    },
    {
        category: "Alternative Sciences",
        maxRoll: 100,
...

    {
        ...
        name: "Astronautics",
        description:
            "The science of the contruction and design of vehicles for travel in space beyond earth's atmosphere.",
    },
    {
        category: "Astronomy",
        maxRoll: 40,
    ...
    },
    {
        ...
        name: "Astrophysics",
        description:
            "Deals with the chemical and physical composition of celestial matter.",
    },
    {
        category: "Astronomy",
        maxRoll: 80,
        ...
        description:
            "Astronomy dealing with electromagnetic radiations of radio frequency received from outside earth's atmosphere.",
    },
    {
        category: "Astronomy",
        maxRoll: 100,
    ...
    },
    {
        ...
        name: "Bio-Physics",
        description:
            "The application of physical principles to biological problems.",
    },
    {
        category: "Biology",
        maxRoll: 21,
        name: "Biotechnology",
        description:
            "Application to biological and medical science of engineering principles or engineering equipment (as in the construction of artificial organs and bionics).",
    },
    {
        category: "Biology",
        maxRoll: 26,
    ...
    },
    {
        ...
        name: "Genetics",
        description:
            "A branch of biology dealing with hereditary and variation of organisms. Genetics allows the recognition of signs of genetic tampering, ability to note genetic abnormalities, and conduct genetic experiments or projects.",
    },
    {
        category: "Biology",
        maxRoll: 42,
        name: "Immunology",
        description:
            "The science dealing with the phenomena and causes of immunity and immune responses.",
    },
    {
        category: "Biology",
        maxRoll: 48,
    ...
    },
    {
        ...
        name: "Neurosciences",
        description:
            "Deals with nerves and nerve tissue and their relation to behavior and learning.",
    },
    {
        category: "Biology",
        maxRoll: 67,
    ...
    },
    {
        ...
        name: "Pharmacology",
        description:
            "The science of drugs including materia medica, toxicology, and therapeutic.",
    },
    {
        category: "Biology",
        maxRoll: 79,
        name: "Phenology",
        description:
            "The study of the reaction of species to environmental phenomenon.",
    },
    {
        category: "Biology",
        maxRoll: 85,
        name: "Physiology",
        description:
            "Deals with the functions of living matter and of the physical and chemical phenomena.",
    },
    {
        category: "Biology",
        maxRoll: 90,
        name: "Psychobiology",
        description:
            "The study of mental life and behavior in relation to other biological processes.",
    },
    {
        category: "Biology",
        maxRoll: 95,
        name: "Radiobiology",
        description:
            "Deals with the interaction of biological systems and radiant energy or radioactive materials.",
    },
    {
        category: "Biology",
        maxRoll: 100,
...

    {
        ...
        name: "Alchemy",
        description:
            "A medieval chemical science and speculative philosophy aiming to achieve the transmutation of the base elements into gold, the discovery of a universal cure for disease, and the discovery of a means of indefinitely prolonging life.",
    },
...

    {
        ...
        description:
            "Engineering dealing with the industrial application of chemistry and development of new chemical technology.",
    },

    {
        ...
        description:
            "Deals with the relation of electricity to chemical changes and with the interconversion of chemical and electrical energy.",
    },

    {
        ...
        description:
            "Deals with only chemical elements found occuring in natural substances.",
    },

    {
        ...
        name: "Polymers",
        description:
            "The study of advanced chemical compounds to form other new materials.",
    },
...

    {
        ...
        name: "Spectroscopy",
        description:
            "Physics that deal with the theory and interpretation of interactions between matter and radiation.",
    },
...

    {
        ...
        bonusContactCount: 2,
        bonusContactType:
            "Professional/Law(40)|Professional/Law Enforcement(75)|Professional/Crime(100)",
        description:
            "Gains Clue Analysis, Counterfeit recognition, identification System, Law, and Police Procedure. This character is trained to notice small clues to a crime, and gains +1CS to find them.",
    },
    ...
    },
    {
        ...
        name: "Forensics",
        description:
            "Forensics is the study of the science of crime scenes. It is the study of the body, the scene, and the evidence. A character with this talent can identify the cause of death, the manner of death, and the time of death.",
    },
    {
        category: "Crime and Law",
        maxRoll: 42,
    ...
    },
    {
        ...
        name: "Intimidation",
        description:
            "A character with this talent knows how to inspire fear in an opponent either through the use of threats, brute strength, or imposing size and gains a +1CS to Intimidation.",
    },
    {
        category: "Crime and Law",
        maxRoll: 47,
    ...
    },
    {
        ...
        name: "Law",
        description:
            "A character with law gains +1CS to all FEATs involving law",
    },
    {
        category: "Crime and Law",
        maxRoll: 64,
        ...
        description:
            "Includes Gun and Law talents and the Police Procedure talent. If a characer is still with the Law Enforcement agency, he may carry a gun and make arrests legally",
    },
    {
        category: "Crime and Law",
        maxRoll: 70,
        ...
        description:
            "Includes Camouflage, Cartography, Demolition, Electronic Countermeasures, guns, and Heavy Weapons and grants a +1CS to all military matters including army weapons. Gain one co ntact in the military.",
    },
    {
        category: "Crime and Law",
        maxRoll: 77,
    ...
    {
        category: "Cognitive Sciences & Humanities",
        maxRoll: 13,
        name: "Anthropology",
        description:
            "Reason FEAT bonuses only if a specific culture is taken. However, an overview is known on the subject. More than one branch can be selected, each taking a talent slot.",
    },
    {
        category: "Cognitive Sciences & Humanities",
        maxRoll: 21,
    ...
    },
    {
        ...
        name: "Cartography",
        description:
            "Enables a character ot draw and interpret maps and grants +1CS to all attempts.",
    },
    {
        category: "Cognitive Sciences & Humanities",
        maxRoll: 39,
    ...
    },
    {
        ...
        description:
            "The study of human speech including the units, structure, modification of language. (Charactor gets to pick one language other than English to be fluent in.)",
    },
    {
        category: "Cognitive Sciences & Humanities",
        maxRoll: 66,
        ...
        description:
            "The study of musical development throughout human history. This does not automatically grant the character with the performer talent.",
    },
    {
        category: "Cognitive Sciences & Humanities",
        maxRoll: 80,
    ...
    },
    {
        ...
        name: "Psychology",
        description:
            "+1CS in all FEATs involving the mind. A popular talent for those with mental powers. These character gain a +1CS on FEATs involving Mental Contact, Domination, Hypnosis, Emotion Control, and Mental Probe powers.",
    },
    ...
    },
    {
        ...
        name: "Hydrology",
        description:
            "Deals with the properties, distribution, and circulation of water on the surface of the land, in the soil and rocks, and in the atmosphere.",
    },
    {
        category: "Earth Sciences",
        maxRoll: 64,
...

    {
        ...
        maxRoll: 6,
        name: "Aviation and Aeronautics Engineering",
        description:
            "This is not piloting. It is the understanding and development of flight principles and aircraft design. There are people who know how to build planes but not fly them. Charactors with this talent get the benefit of having their projects cost -1CS less in resource rank to build.",
    },
    {
        category: "Engineering",
        maxRoll: 11,
        ...
        description:
            "This allows the character to design, build and modify out of atmosphere space craft. Charactors with this talent get the benefit of having their projects cost -1CS less in resource rank to build.",
    },
    {
        category: "Engineering",
        maxRoll: 16,
    ...
    },
    {
        category: "Engineering",
        maxRoll: 19,
        name: "Battlesuit Design",
        description:
            "This skill allows the character +1CS to design and build battlesuits, harnesses, etc.",
    },
    {
        category: "Engineering",
        maxRoll: 21,
    ...
    },
    {
        ...
        name: "Demolitions",
        description:
            "Precise knowledge of how to build, use and diffuse explosive devices.",
    },
    {
        category: "Engineering",
        maxRoll: 31,
        name: "Gadgetry",
        description:
            "Can build gadgetry, and recieve a +1CS to all FEATs involving them.",
    },
    {
        category: "Engineering",
        maxRoll: 35,
        name: "Identify Gadgets",
        description:
            "Enables a character to Identify and use Gadgets but not build them. Alien technology results in -1CS to -5CS",
    },
    {
        category: "Engineering",
        maxRoll: 38,
    ...
    },
    {
        ...
        description:
            "Includes the building of ships, submarines and underwater constructs.",
    },
    {
        category: "Engineering",
        maxRoll: 57,
        ...
        description:
            "The character with talent is capable of building complex machines for an assortment of tasks.",
    },
    {
        category: "Engineering",
        maxRoll: 63,
    ...
    },
    {
        ...
        description:
            "Deals with the construction and development of nuclear powered, manipulating and control devices.",
    },
    {
        category: "Engineering",
        maxRoll: 76,
    ...
    },
    {
        ...
        name: "Robotics",
        description:
            "This skill allows a +1CS in dealing with Robotic construction, design, matianence, and theory. When used with the computer skill, the character can design AI constructions.",
    },
    {
        category: "Engineering",
        maxRoll: 88,
        ...
        description:
            "This allows the character to design, build and modify structural complexes (buildings, bases, tunnels, mines, etc.) Building bases or hideouts are -1CS to effective cost of course.",
    },
    {
        category: "Engineering",
        maxRoll: 95,
        ...
        description:
            "Precise knowledge of how to build, use and modify guns, missiles and artillery. This talent does not include explosive devices. (see Demolitions.)",
    },
    {
        category: "Engineering",
        maxRoll: 100,
    ...
    },
    {
        ...
        name: "Martial Arts E",
        description:
            "This form of martial arts encourages quick striking to catch the opponent off-guard. Heroes with this form of Martial Arts are at +1CS to initiative rolls in unarmed combat.",
    },
    {
        category: "Fighting",
        maxRoll: 42,
    ...
    },
    {
        ...
        name: "Quick-Striking",
        description:
            "Charactors with this talent gain +1CS to Fighting FEATs involving trying for multiple attack rolls. Also gains a +1 on initiative rolls.",
    },
    {
        category: "Fighting",
        maxRoll: 94,
    ...
    },
    {
        ...
        description:
            "This character is capable of working in a trauma unit, emergency room or any other kind of immediate care.",
    },
    {
        category: "Medicine",
        maxRoll: 33,
        name: "First Aid",
        description:
            "This Talent grants the character the ability to immediately halt Endurance rank loss, the and the recovery of one rank immediately. In addition, the hero with this Talent can stabilize a dying character at Shift-0 Health up to 5 rounds after that character reaches that level.",
    },
    {
        category: "Medicine",
        maxRoll: 39,
    ...
    },
    {
        ...
        name: "Psychiatry",
        description:
            "Deals with mental, emotional and behavioral disorders. The hero with this Talent has a background in studies of the mind, and as such gains a + 1CS on all FEATs involving the mind.",
    },
    {
        category: "Medicine",
        maxRoll: 87,
    ...
    },
    {
        ...
        name: "Demonologist",
        description:
            "The character has studied accounts of demons and he knows how dangerous and hostile they are. The character receives a +1CS in any situation involving demons, including research, communication, identification and combat.",
    },
    {
        category: "Mystic and Mental",
        maxRoll: 24,
    ...
    },
    {
        ...
        name: "Ritual Magics",
        description:
            "Reason FEAT to perform magical ceremonies. To do this you need knowledge of the ceremony (usually from a book), equiptment, and time. Time is 1d20 times 2 = rounds of spellcasting needed.",
    },
    {
        category: "Mystic and Mental",
        maxRoll: 61,
    ...
    },
    {
        ...
        name: "Actor",
        description:
            "This gives the ability to be used to disguise a character. An actor recieves a +1CS to all disguise attempts and opponents recieve a -1CS to seeing through the disguise",
    },
    {
        category: "Other",
        maxRoll: 14,
    ...
    },
    {
        ...
        bonusContactCount: 2,
        description:
            "Being involved with politics in the public eye, you are either realy liked or really hated. If the charcter is already freindly you gain a +1CS in getting help, but if the character is unfriendly or hostile you recieve an additional -1CS. You gain 2 contacts, Usually your chief supporter",
    },
    {
        category: "Other",
        maxRoll: 76,
    ...
    },
    {
        ...
        bonusContactCount: 2,
        description:
            "Charactor know the streets and how to survive theere. Charactor also gains 2 contacts at the street level",
    },
    {
        category: "Other",
        maxRoll: 93,
    ...
    },
    {
        ...
        name: "Thief",
        description:
            "Allows the ability to picklocks, access security, and safecracking",
    },
    {
        category: "Other",
        maxRoll: 99,
    ...
    },
    {
        ...
        name: "Literature",
        description:
            "Enables a character to produce novel, screenplays, comic books, poetry, coloring books. Takes at least a week to complete.",
    },
    ...
    },
    {
        category: "Physics",
        maxRoll: 66,
        name: "Energy and Particle Physics",
        description:
    ...
    },
    {
        category: "Piloting",
        maxRoll: 27,
        name: "Automobile Specialist",
        description:
            "+1CS to driving and controlling cars, trains, tanks, hovercrafts, etc.",
    },
    {
        category: "Piloting",
        maxRoll: 38,
        name: "Boat Pilot",
        description:
            "+1CS to all FEATs involving sailboats, aircraft carriers, submarines, tugboats, and so on.",
    },
    {
        category: "Piloting",
        maxRoll: 50,
    ...
    },
    {
        category: "Piloting",
        maxRoll: 63,
        name: "Military Vehicle Specialist",
    ...
    },
    {
        category: "Piloting",
        maxRoll: 100,
        name: "Submersible Vehicle",
        description:
            "Includes submarines, diving bells and other underwater vehicles.",
    },
    ...
    },
    {
        ...
        name: "Weapons Master",
        description:
            "Charactor gains a +1CS to hit with any weapon that requires a Fighting FEAT to hit.",
    },
    {
        category: "Weapons",
        maxRoll: 100,
        ...
        description:
            "Charactor gains +2CS with a single weapon of choice. Charactor also recieves a +1 to initiative when using that weapon.",
    },
];
...
const CONTACT_TYPE_LIST_ULTIMATE_TABLE = [
    {
        ...
        name: "Medicine",
        description:
            "The hero with this Contact has a friend, ally or acquaintance with Medicine Talent, who will provide medical advice and services either for free or charge an affordable fee.",
    },
    {
        category: "Professional",
        maxRoll: 18,
        name: "Law",
        description:
            "The hero with this Contact has a friend, ally, or acquaintance with Law Talent, who will provide legal assistance for a reduced fee and legal advice to the hero for free.",
    },
    {
        category: "Professional",
        maxRoll: 27,
        name: "Law Enforcement",
        description:
            "The hero with this Contact has a friend, ally, or acquaintance with Law-enforcement Talent, who is in addition a member of the law-enforcement profession.",
    },
    {
        category: "Professional",
        maxRoll: 36,
        name: "Business World",
        description:
            "The character has a Contact in the world of business or finance.",
    },
    {
        category: "Professional",
        maxRoll: 45,
    ...
    },
    {
        ...
        name: "Crime",
        description:
            "The character with this Contact has some connection with the criminal underworld. This ranges from having a snitch that passes on information about street action up to a Contact high in the hierarchy of organized crime.",
    },
    {
        category: "Professional",
        maxRoll: 63,
    ...
    },
    {
        ...
        name: "Espionage",
        description:
            "The character with this Contact has connections with the world of espionage. This includes agencies such as the FBI, CIA, NSA, KGB, Interpol, or MI5.",
    },
    {
        category: "Professional",
        maxRoll: 98,
        name: "Media",
        description:
            "The character with this Contact has connections with his Tribe. , and as such may enjoy the privileges thereof. This includes using their equipment, calling them in on an emergency, and benefitting from their other resources.",
    },
    {
        category: "Professional",
        maxRoll: 100,
        name: "Hero Group",
        description:
            "The character has some connection with, or was or is a member of or an ally of some existing group of super-powered heroes, and as such may enjoy the privileges thereof. This includes using their equipment, calling them in on an emergency, using their HQ, and benefitting from their training.",
    },
    {
        category: "Scientific",
        maxRoll: 8,
        name: "Laboratory",
        description:
            "The character with this Contact has some connection with a character in the fields of chemistry.",
    },
    {
        category: "Scientific",
        maxRoll: 14,
    ...
    },
    {
        ...
        name: "Biology",
        description:
            "The character with this Contact has some connection with a character in the fields of biology.",
    },
    {
        category: "Scientific",
        maxRoll: 37,
        name: "Geology",
        description:
            "The character with this Contact has some connection with a character in the fields of geology.",
    },
    {
        category: "Scientific",
        maxRoll: 49,
        name: "Genetics",
        description:
            "The character with this Contact has some connection with a character in the fields of genetics.",
    },
    {
        category: "Scientific",
        maxRoll: 62,
        name: "Archeology",
        description:
            "The character with this Contact has some connection with a character in the fields of archeology.",
    },
    {
        category: "Scientific",
        maxRoll: 75,
        name: "Physics",
        description:
            "The character with this Contact has some connection with a character in the fields of physics.",
    },
    {
        category: "Scientific",
        maxRoll: 87,
        name: "Computers",
        description:
            "The character with this Contact has some connection with a character in the fields of computers.",
    },
    {
        category: "Scientific",
        maxRoll: 100,
        name: "Electronics",
        description:
            "The character with this Contact has some connection with a character in the fields of electronics.",
    },
    {
        category: "Political",
        maxRoll: 20,
        name: "Tribe",
        description:
            "The hero has an ally in the local political scene: alderman, mayor, or councilman. The Contact may provide information on what is going on in the neighborhood. ",
    },
    {
        category: "Political",
        maxRoll: 50,
    ...
    },
    {
        ...
        name: "State",
        description:
            "The hero has an ally in state government — connected with the office of governor, a state representative, or someone in one of the state agencies.",
    },
    {
        category: "Political",
        maxRoll: 85,
        name: "National",
        description:
            "The hero has a Contact in national government — a congressional aide, a congressman, representative, member of the Executive Branch or one of the myriad number of agencies in the capital.",
    },
    {
        category: "Political",
        maxRoll: 90,
    ...
    },
    {
        ...
        name: "International",
        description:
            "The hero has Contacts in the UN or in a similar multi-national organization, such as the Common Market of Europe.",
    },
    {
        category: "Political",
        maxRoll: 98,
    ...
    },
    {
        ...
        name: "Planetary",
        description:
            "This Contact is available to Alien characters only. The hero is well-known to the inhabitants and/or rulers of another planet, provided they can get in contact with those sources. ",
    },
    {
        ...
        name: "Occult Lore",
        description:
            "The hero knows someone who dabbles in the darker arts. The Contact may provide advice on mystic writings, spells and their castings, and curses. The Contact is not necessarily a true magic-wielder. ",
    },
    {
        category: "Mystic Arts",
        maxRoll: 100,
        name: "Mythology",
        description:
            "The hero knows someone who studies recognized mythology and actions of the extra-dimensional beings known as gods (Olympians, Asgardians, etc.). The Contact will specialize in one pantheon of deities.",
    },
];
