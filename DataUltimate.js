...
const PHYSICAL_FORM_ULTIMATE_TABLE = [
    ...
    },
    {
        ...
        column: 1,
        bonusTalentCount: 1,
        bonusTalent: "Fighting\\Climbing(100)",
        description:
    ...
    },
    {
        ...
        popularityStart: 0,
        description:
            "Demihumans can be unique individuals or members of a race that inhabits a different place or time.  Lamians are snake people. The legs have been replaced by a serpentine body, although the arms are normal. The skin is covered in fine scales. Lamians have lidless eyes and retractable fangs.  Lamians are difficult to bind (+ 1CS to escape).",
    },
    {
        maxRoll: 69,
    ...
    },
    {
        ...
        name: "Ethereal",
        column: 1,
        optionalContact: "Mystic Arts\\Occult Lore(100)",
        description:
...
const ORIGIN_ULTIMATE_TABLE = [
    ...
    },
    {
        ...
        description:
            "The hero was caught in an experiment or procedure gone awry, with the result that the hero gained Powers that were totally unexpected. Such freak conditions cannot be completely duplicated, although they can be simulated.",
    },
    {
        maxRoll: 60,
...
const POWER_LIST_ULTIMATE_TABLE = [
    ...
    },
    {
        ...
        description:
            "Normally a character's Intelligence is determined in the Character Generation Process. The hyper-intelligent character is a genius of awesome potential. He can quickly master new subjects, retain that knowledge indefinitely, and easily succeed in any mental endeavor.",
    },
    {
        category: "Mental Enhancement",
        code: "M14",
...
const CONTACT_TYPE_LIST_ULTIMATE_TABLE = [
    {
        ...
        name: "Medicine",
        description:
            "The hero with this Contact has a friend, ally or acquaintance with Medicine Talent, who will provide medical advice and services either for free or charge an affordable fee. The Contact may be a doctor at a local hospital or clinic, or a researcher familiar with the character's background.",
    },
    {
        category: "Professional",
        maxRoll: 18,
...

    {
        ...
        name: "Tribe",
        description:
            "The hero has contacts within his own tribe, race, or family group. The Contact may provide information on what is going on in the neighborhood.",
    },
    {
        category: "Political",
        maxRoll: 50,
    ...
    },
    {
        ...
        name: "State",
        description:
            "The hero has an ally in state government — connected with the office of governor, a state representative, or someone in one of the state agencies. The Contact may provide Good services and information, as well as equipment of up to Remarkable Resource cost. ",
    },
    {
        category: "Political",
        maxRoll: 85,
    ...
    },
    {
        ...
        name: "International",
        description:
            "The hero has Contacts in the UN or in a similar multi-national organization, such as the Common Market of Europe. This type of Contact can provide equipment of up to Monstrous Resource rank. ",
    },
    {
        category: "Political",
        maxRoll: 100,
    ...
    },
    {
        ...
        name: "Mythology",
        description:
            "Similar to Occult Lore, with the direction towards recognized mythology: actions of the extra-dimensional beings known as gods (Olympians, Asgardians, etc.). The Contact will specialize in one pantheon of deities.",
    },
];
