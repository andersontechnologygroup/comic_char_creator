...
const TALENT_LIST_ULTIMATE_TABLE = [
    ...
    },
    {
        ...
        name: "Thrown Weapons",
        description:
            "Characters with this Talent toss weapons designed to be thrown (including spears, daggers, shuriken, disks, and snowballs)",
    },
    {
        category: "Weapon Skills",
        maxRoll: 60,
        name: "Bows",
        description:
            "Bows are tricky items to operate.  Those with this Talent gain a + 1CS to hit with all bows, including crossbows, and may fire and reload in a single round. They may fire multiple arrows on a successful Agility FEAT.",
    },
    {
        category: "Weapon Skills",
        maxRoll: 80,
        name: "Blunt Weapons",
        description:
            "Characters with this Talent gain a + 1CS to hit when attacking with a blunt weapon.",
    },
    {
        category: "Weapon Skills",
        maxRoll: 90,
        name: "Sharp Weapons",
        description:
            "Characters with this Talent gain a + 1CS to hit when attacking with a sharp weapons.  This includes swords, daggers (unless thrown), and spears, but excludes claws and other natural extensions that inflict this type of damage.",
    },
    {
        category: "Weapon Skills",
        maxRoll: 100,
        ...
        description:
            "This a special category that grants the character a + 1CS to Fighting or Agility when using the following weapons: shuriken, crossbows, sais (treat as swords), and oriental swords and daggers (including the katana and the kris).",
    },
    {
        category: "Weapon Skills",
        maxRoll: 100,
        ...
        talentCount: 2,
        description:
            "The character with this Talent gains a + 1CS to hit with any distance weapon that requires line of sight to hit (the character could benefit when firing heavy artillery, but not when controlling a tele-guided missile). Such a weapon in the hands of a.marksman does not suffer penalties to hit from range.",
    },
    {
        category: "Weapon Skills",
        maxRoll: 100,
        ...
        talentCount: 2,
        description:
            "The character with this Talent gains a + 1CS to hit with any weapon that requires a Fighting FEAT to hit.",
    },
    {
        category: "Weapon Skills",
        maxRoll: 100,
...

    {
        ...
        name: "Martial Arts A",
        description:
            "This form of martial arts concentrates on using an opponent's strength against him, and is typical of oriental- American forms such as judo and karate. The practioner of this type of martial arts can Stun or Slam an opponent regardless of their comparative Strengths and Endurances.",
    },
    {
        category: "Fighting Skills",
        maxRoll: 20,
        name: "Martial Arts B",
        description:
            "This form of martial arts is keyed on offense and inflicting damage in short, quick bursts, and includes such disciplines as boxing. The practioner of this form of martial arts gains a + 1CS to Fighting ability when engaged in unarmed combat.",
    },
    {
        category: "Fighting Skills",
        maxRoll: 30,
    ...
    },
    {
        ...
        name: "Wrestling",
        description:
            "The hero with this Talent is proficient in applying holds . It includes familiar types of wrestling a s well as the sumo forms of the art. The hero with this Talent gains a +2CS when making Grappling attacks, but gains no benefit in damage. (A hero with Martial Arts B and this Talent gains a +3CS to hit in a Grappling attack, and a + 1CS for damage.) ",
    },
    {
        category: "Fighting Skills",
        maxRoll: 70,
        name: "Thrown Objects",
        description:
            "The hero with this Talent gains a + 1CS with all Throwing attacks (both Edged and Blunt), and + 1CS on Catching. This applies to both thrown weapons and normal items. If the hero has the Thrown Weapons Talent as well, the modification is + 2CS when using thrown weapons. ",
    },
    {
        category: "Fighting Skills",
        maxRoll: 80,
    ...
    },
    {
        ...
        name: "Pilot",
        description:
            "The character with this Talent has a working knowledge of most aircraft, and receives a + 1CS for all FEAT rolls involving an aircraft that character is controlling (including Control FEATs, Agility FEATS, and Reason FEAT's involving aircraft handling and design). A character with a background that would permit it (a hero who is an alien may extend this Talent to spacecraft as well. ",
    },
    {
        category: "Professional Skills",
        maxRoll: 40,
    ...
    },
    {
        ...
        name: "Biology",
        description:
            "A + 1CS on matters of biology, including animal and plant identification, finding cures for organic poisons, and researching diseases and their cures. ",
    },
    {
        category: "Scientific Skills",
        maxRoll: 60,
        name: "Geology",
        description:
            "A + 1CS on matters involving the Earth, including volcanic activity, the geology of the surrounding land, types of rocks and their powers, and mineral identification. ",
    },
    {
        category: "Scientific Skills",
        maxRoll: 70,
        name: "Genetics",
        description:
            "A + 1CS on matters involving the genes, including creating new life forms, understanding mutants, and researching diseases. ",
    },
    {
        category: "Scientific Skills",
        maxRoll: 80,
        name: "Archeology",
        description:
            "A + 1CS on matters involving the past, including paeleontology, historical records, and ancient myths and legends. ",
    },
    {
        category: "Scientific Skills",
        maxRoll: 90,
        ...
        name: "Physics",
        description:
            "A + 1CS on matters involving physics and astrophysics, including motion, flight, and the planets and stars. ",
    },
    {
        category: "Scientific Skills",
        maxRoll: 90,
        ...
        name: "Computers",
        description:
            "A + 1CS on matters involving computers, computer-controled equipment, and artificial intelligences. ",
    },
    {
        category: "Scientific Skills",
        maxRoll: 100,
    ...
    },
    {
        ...
        description:
            "This is a Psi-Screen that may be developed by the individuals without that Power. This permits the character to resist mental attacks as if the character had a mental power of Psyche + 1CS. The Talent is passive in nature, and does not grant any other particular benefit. A character with Mental Probe may be able to discern where the character gained this Talent, but nothing else. ",
    },
    {
        category: "Mystic and Mental Skills",
        maxRoll: 90,
        ...
        talentCount: 2,
        description:
            "In the Marvel Universe, all humankind has the potential for developing magical Powers. This Talent shows that the character has some background with magical forces. Heroes may have derived their powers from these forces if they choose this Talent. A character with this Talent may have Magical Powers, with the approval of the Judge.",
    },
    {
        category: "Mystic and Mental Skills",
        maxRoll: 100,
        name: "Occult Lore",
        description:
            "The character with this Talent has a knowledge of magical societies, antiquities, runes, and a general understanding of forgotten lore. The character gains a + 1CS to Reason FEATS involving items of a magical nature. ",
    },

    {
        ...
        name: "Artist",
        description:
            "The character with an artist background creates works of art, either for himself or for sale to others. This includes painting, sculpting, and writing. A single work takes 1-10 weeks, and upon completion grants the artist Karma points equal to 10 times the number of weeks. The character must allocate some time daily at his work. ",
    },
    {
        category: "Other Skills",
        maxRoll: 40,
    ...
    },
    {
        ...
        name: "Trivia",
        description:
            "This is a general category that covers any one subject desired by the character. On that subject, the character gains +1CS to all Reason FEATS. (Say, the character is into collecting Spores and Fungus. A Trivia Talent would be: Trivia/Spores and Fungus). Trivia categories should be specific (old movies, military history, sports, rock music, comic books) as opposed to general (all knowledge) or covered by other Talents.",
    },
    {
        category: "Other Skills",
        maxRoll: 100,
    ...
    },
    {
        ...
        talentCount: 2,
        description:
            "The Student character has no other initial Talents, but may gain other Talents at a discounted price. New Talents cost 1000 Karma points if learned from another player character, if learned from outside. Students may maintain Advancement Totals for a Talent along with other forms of Advancement funds. ",
    },
    {
        category: "Other Skills",
        maxRoll: 100,
