...
Tester.DeterminePopularityTests = (gen) => {
    ...
    Tester.assert(
        char2.state.popularity.final !== undefined,
...
Tester.DetermineAbilityTests = (gen) => {
    ...
    Tester.assertNotNull(
        rankRow.rank,
        "determineAbility rank row has a rank name.",
    );
    Tester.assert(
        rankRow.rankNumber > 0,
