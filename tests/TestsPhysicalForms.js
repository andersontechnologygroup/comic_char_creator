...
const PHYSICAL_FORM_ASSERTIONS = {
  "Normal Human": [
    { path: "resources.adjustment", value: 2, msg: "Resources adjusted by 2." },
  ],
  "Mutant - Induced": [
    { path: "anyAbilityAdjustment", op: "notNull", msg: "anyAbilityAdjustment fired." },
  ],
  "Mutant - Random": [
    { path: "powersCount.adjustment", value: 1, msg: "Powers Count adjusted by 1." },
    { path: "resources.adjustment", value: -1, msg: "Resources adjusted by -1." },
    { path: "abilityAdjustments.Endurance", value: 1, msg: "Endurance adjusted by 1." },
  ],
  "Mutant - Breed": [
    { path: "abilityAdjustments.Endurance", value: 1, msg: "Endurance adjusted by 1." },
    { path: "abilityAdjustments.Intuition", value: 1, msg: "Intuition adjusted by 1." },
  ],
  "Android": [
    { path: "powersCount.adjustment", value: 1, msg: "Powers Count adjusted by 1." },
    { path: "anyAbilityAdjustment", op: "notNull", msg: "anyAbilityAdjustment fired." },
    { path: "popularity.adjustment", value: -1, msg: "Popularity adjusted by -1." },
  ],
  "Humanoid Race": [
    { path: "anyAbilityAdjustment", op: "notNull", msg: "anyAbilityAdjustment fired." },
    { path: "resources.startRank", value: 3, msg: "Resources start at rankNumber 3." },
  ],
  "Surgical Composite": [
    { path: "abilityAdjustments.Endurance", value: 1, msg: "Endurance adjusted by 1." },
    { path: "resources.startRank", value: 3, msg: "Resources start at rankNumber 3." },
    { path: "abilityAdjustments.Strength", value: 1, msg: "Strength adjusted by 1." },
    { path: "abilityAdjustments.Fighting", value: 1, msg: "Fighting adjusted by 1." },
    { path: "popularity.start", value: 0, msg: "Popularity starting at 0." },
  ],
  ...
  "Demihuman - Chiropteran": [
    { path: "popularity.start", value: 1, msg: "Popularity starting at 1." },
    { validate: (char, s) => {
      Tester.assertHasPower('Sonar (Active)', char.powers,
        'Demihuman - Chiropteran has bonus power of Sonar (Active).');
      const p = char.powers.find(p => p.name === "Sonar (Active)");
      Tester.assertEquals("Good", p.rank,
  ...
  "Demihuman - Merhuman": [
    { path: "popularity.adjustment", value: 1, msg: "Popularity adjusted by 1." },
    { validate: (char, s) => {
      Tester.assertHasPower('Water Freedom', char.powers,
  ...
  "Cyborg - Mechanical Body": [
    { path: "abilityAdjustments.Intuition", value: -1, msg: "Intuition adjusted by -1." },
    { path: "abilityAdjustments.Psyche", value: -1, msg: "Psyche adjusted by -1." },
  ],
  "Cyborg - Mechanically Augmented": [
    { path: "powersCount.adjustment", value: -1, msg: "Powers Count adjusted by -1." },
    { path: "resources.set", value: 16, msg: "Resources set to 16." },
    { validate: (char, s) => {
      Tester.assert(char.isHiTech,
  ...
  "Robot - Metamorphic": [
    { path: "abilitiesToGenerate", value: 2, msg: "Abilities to Generate set to 2." },
  ],
  "Robot - Computer": [
    { path: "resources.adjustment", value: 1, msg: "Resources adjusted by 1." },
    { path: "abilityAdjustments.Fighting", value: -1, msg: "Fighting adjusted by -1." },
    { path: "abilityAdjustments.Reason", value: 2, msg: "Reason adjusted by 2." },
    { path: "allPrimaryAbilityAdjustment", op: "notNull", msg: "All Primary Abilities adjusted." },
    { path: "allPrimaryAbilityAdjustment.adjustment", value: -1, msg: "All Primary Abilities adjusted by -1." },
    { path: "powersRankAdjustment", value: -1, msg: "All Power Rank adjusted by -1." },
  ],
  "Deity": [
    { path: "powersCount.adjustment", value: 2, msg: "Powers Count adjusted by 2." },
    { path: "popularity.adjustment", value: 2, msg: "Popularity adjusted by 2." },
    { path: "allPrimaryAbilityAdjustment", op: "notNull", msg: "All Primary Abilities adjusted." },
    { path: "allPrimaryAbilityAdjustment.adjustment", value: 2, msg: "All Primary Abilities adjusted by 2." },
    { validate: (char, s) => {
      const deityPower = char.powers.find(p => p.category === "Travel");
      Tester.assertEquals('Travel', deityPower.category,
        'Deity has bonus power of category Travel.');
    }},
  ],
  "Angel/Demon": [
    { path: "allPhysicalAbilityAdjustment", op: "notNull", msg: "All Physical Abilities adjusted." },
    { path: "allPhysicalAbilityAdjustment.adjustment", value: 1, msg: "All Physical Abilities adjusted by 1." },
    { validate: (char, s) => {
      if (char.subType === "Angel") {
        Tester.assertHasPower('Artifact Creation', char.powers,
          'Angel has bonus power of Artifact Creation.');
        const angelPower = char.powers.find(p => p.name === "Artifact Creation");
        Tester.assertEquals("Good", angelPower.rank,
          "Angel Artifact Creation must be Good rank.");
        Tester.assertEquals(2, s.popularity.adjustment, "Angel: Popularity adjusted by 2.");
      } else if (char.subType === "Demon") {
        Tester.assertHasPower('Fire Generation', char.powers,
          'Demon has bonus power of Fire Generation.');
        const demonPower = char.powers.find(p => p.name === "Fire Generation");
        Tester.assertEquals("Good", demonPower.rank,
          "Demon Fire Generation must be Good rank.");
        Tester.assertEquals(-2, s.popularity.adjustment, "Demon: Popularity adjusted by -2.");
      }
    }},
  ],
  "Animal": [
    { validate: (char, s) => {
      const animalPowers = char.powers.filter(p => p.bonusPower && p.category === "Detection");
      Tester.assertEquals(2, animalPowers.length,
        "Animal has 2 bonus powers of category Detection.");
      Tester.assertEquals("Good", animalPowers[0].rank,
        "Animal has bonus power(1) of category Detection at Good rank.");
      Tester.assertEquals("Good", animalPowers[1].rank,
        "Animal has bonus power(2) of category Detection at Good rank.");
    }},
  ],
  "Vegetable": [
    { validate: (char, s) => {
      Tester.assertHasPower('Absorption Power', char.powers,
        'Vegetable has bonus power of Absorption Power.');
      const vegPower = char.powers.find(p => p.name === "Absorption Power");
      Tester.assertEquals("Good", vegPower.rank,
        "Vegetable Absorption Power must be Good rank.");
    }},
  ],
  "Energy": [
    { validate: (char, s) => {
      const energyEmission = char.powers.filter(p => p.category === "Energy Emission");
      const energyControl = char.powers.filter(p => p.category === "Energy Control");
      Tester.assertAtLeast(2, energyEmission.length + energyControl.length,
  ...
  "Mineral": [
    { path: "healthAdjustment", op: "notNull", msg: "Health adjustment exists." },
    { path: "healthAdjustment.type", value: "multiply", msg: "Health adjustment is multiply." },
    { path: "healthAdjustment.value", value: 2, msg: "Health multiplied by 2." },
  ],
  "Gaseous": [
    { path: "resources.set", value: 1, msg: "Resources set to 1." },
  ],
  "Undead": [
    { path: "abilityAdjustments.Endurance", value: 1, msg: "Endurance adjusted by 1." },
    { path: "abilityAdjustments.Strength", value: 1, msg: "Strength adjusted by 1." },
...
function _assertPhysicalFormState(form, s, char) {
  ...
  for (const d of defs) {
    if (d.validate) {
      ...
      Tester.assert(actual !== null && actual !== undefined,
        `${form}: ${d.msg}`);
    } else {
      const actual = _resolvePath(s, d.path);
...
Tester.GeneratorUltimatePhysicalFormTests = (gen) => {
  ...
  for (let index = 0; index < gen.physicalFormTable.length; index++) {
    ...
    Tester.assertEquals(gen.physicalFormTable[index].name, char.physicalForm,
...
Tester.GeneratorCompoundTests = (gen) => {
  ...
  Tester.assertEquals("Compound", char.physicalForm,
    `Physical Form Roll (Ultimate): Generated '${char.physicalForm}'.`);
  Tester.assertEquals(2, char.bodyTypes.length,
    `Body Type Roll (Ultimate): Generated '${char.bodyTypes.length}'.`);
  Tester.assertEquals("Normal Human", char.bodyTypes[0],
    `Body Type Roll (Ultimate): Generated '${char.bodyTypes[0]}'.`);
  Tester.assertEquals("Mutant - Random", char.bodyTypes[1],
    `Body Type Roll (Ultimate): Generated '${char.bodyTypes[1]}'.`);
  Tester.assertEquals(2, gen.randomRanksColumn,
  ...
  Tester.assertEquals(2, char2.bodyTypes.length,
    `Body Type Roll (Ultimate): Generated '${char2.bodyTypes.length}'.`);
  Tester.assertEquals("Normal Human", char2.bodyTypes[0],
    `Body Type Roll (Ultimate): Generated '${char2.bodyTypes[0]}'.`);
  Tester.assertEquals("Mutant - Random", char2.bodyTypes[1],
    `Body Type Roll (Ultimate): Generated '${char2.bodyTypes[1]}'.`);
  Tester.assertEquals(2, gen2.randomRanksColumn,
  ...
  Tester.assertEquals("Compound", char3.physicalForm,
    `Physical Form Roll (Ultimate): Generated '${char3.physicalForm}'.`);
  Tester.assertEquals(3, char3.bodyTypes.length,
    `Body Type Roll (Ultimate): Generated '${char3.bodyTypes.length}'.`);
  Tester.assertEquals("Normal Human", char3.bodyTypes[0],
    `Body Type Roll (Ultimate): Generated '${char3.bodyTypes[0]}'.`);
  Tester.assertEquals("Mutant - Random", char3.bodyTypes[1],
    `Body Type Roll (Ultimate): Generated '${char3.bodyTypes[1]}'.`);
  Tester.assertEquals("Robot - Metamorphic", char3.bodyTypes[2],
    `Body Type Roll (Ultimate): Generated '${char3.bodyTypes[2]}'.`);
  Tester.assertEquals(2, gen3.randomRanksColumn,
...
Tester.GeneratorBonusContactTest = (gen) => {
  ...
  Tester.assertEquals("Mutant - Breed", char.physicalForm,
    `Physical Form: Generated '${char.physicalForm}'.`);
  Tester.assertAtLeast(1, char.contacts.length,
    `Contact Count (Ultimate): Generated '${char.contacts.length}'.`);
  Tester.assertEquals("Tribe", char.contacts[0].name,
...
Tester.GeneratorDemonSubTypeTest = (gen) => {
  ...
  const angelDemonRow = gen.physicalFormTable.find(o => o.name === 'Angel/Demon');
  if (!angelDemonRow) {
  ...
  const char = gen.generateWithoutThrows();
  Tester.assertEquals('Angel/Demon', char.physicalForm,
    `DemonSubType: Generated '${char.physicalForm}'.`);
  Tester.assertEquals('Demon', char.subType,
  ...
  if (s.popularity && s.popularity.adjustment !== undefined) {
    Tester.assertEquals(-2, s.popularity.adjustment,
...
Tester.GuardClauseMissingFormTest = (gen) => {
  ...
  const idx = gen.physicalFormTable.findIndex(o => o.name === 'Angel/Demon');
  ...
  Tester.assert(char.physicalForm !== 'Angel/Demon',
