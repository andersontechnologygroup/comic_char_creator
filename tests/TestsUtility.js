...
Tester.UtilityTests = (gen) => {
    ...
    Tester.assertEquals(
        "Excellent",
        foundRank,
        `findRank(${testRoll}, ${testColumn}) should return "Excellent"`,
    );
    ...
    Tester.assertEquals(
        "Typical",
        foundRank,
        `findRank(${testRoll}, ${testColumn}) should return "Typical"`,
    );
    ...
    Tester.assertEquals(
        "Good",
        foundRank,
        `findRank(${testRoll}, ${testColumn}) should return "Good"`,
    );
    ...
    Tester.assertEquals(
        "Remarkable",
        foundRank,
        `findRank(${testRoll}, ${testColumn}) should return "Remarkable"`,
    );
    ...
    Tester.assertEquals(
        "Incredible",
        foundRank,
        `findRank(${testRoll}, ${testColumn}) should return "Incredible"`,
    );
    ...
    Tester.assertEquals(
        "Amazing",
        foundRank,
        `findRank(${testRoll}, ${testColumn}) should return "Amazing"`,
    );
...
Tester.DiceRollCountTests = () => {
    ...
    Tester.assertEquals(
        0,
        Dice.rollCount,
        "Dice.rollCount: reset to 0 via seed(null).",
    );
    ...
    Tester.assertEquals(
        0,
        Dice.rollCount,
        "Dice.rollCount: reset to 0 via seed(42).",
    );
    ...
    Tester.assertEquals(
        4,
        Dice.rollCount,
        "Dice.rollCount: 4 after roll100().",
    );
    ...
    Tester.assertEquals(
        4,
        Dice.rollCount,
        "Dice.rollCount: still 4 after getRandomItem().",
    );
    ...
    Tester.assertEquals(
        14,
        Dice.rollCount,
        "Dice.rollCount: 14 after 10 more rolls.",
    );
    ...
    Tester.assertEquals(
        0,
        Dice.rollCount,
        "Dice.rollCount: reset to 0 via seed(99).",
    );
